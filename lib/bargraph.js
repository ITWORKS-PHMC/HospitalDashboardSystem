...
(function () {
  ...
  function Aa(d) {
    d.roundRect = function (d, T, p, v, sa, D, t, A) {
      t && (this.fillStyle = t);
      ...
      this.beginPath();
      this.moveTo(d + sa, T);
      this.lineTo(d + p - sa, T);
      this.quadraticCurveTo(d + p, T, d + p, T + sa);
      this.lineTo(d + p, T + v - sa);
      this.quadraticCurveTo(d + p, T + v, d + p - sa, T + v);
      this.lineTo(d + sa, T + v);
      this.quadraticCurveTo(d, T + v, d, T + v - sa);
      this.lineTo(d, T + sa);
      this.quadraticCurveTo(d, T, d + sa, T);
      this.closePath();
      t && this.fill();
      A && 0 < D && this.stroke();
    };
  ...
  function ib(d) {
    ...
    if (d.exportEnabled && d._dropdownMenu) {
      var p = -1 !== d.theme.indexOf("dark") ? "black" : "#888888";
      K(d._dropdownMenu, {
        backgroundColor: d.toolbar.itemBackgroundColor,
        color: d.toolbar.fontColor,
  ...
  function ta(d, l, p) {
    ...
    l.getAttribute("state") !== p &&
      ...
      (l.innerHTML =
        ...
        "' />"),
      K(l.childNodes[0], { height: "95%", pointerEvents: "none" }));
  ...
  function Z(d, l, v, V, $) {
    ...
    d = {};
    this.theme && p(this.parent) && p(l) && p(V)
      ...
      : this.parent &&
        ...
        (null === V
          ...
          : 0 < this.parent.themeOptions[l].length &&
            ((V = Math.min(this.parent.themeOptions[l].length - 1, V)),
            (d = this.parent.themeOptions[l][V])));
    this.themeOptions = d;
  ...
  function Ba(d, l) {
    ...
    if (p(this.options.margin) && d.options.subtitles)
      for (var v = d.options.subtitles, V = 0; V < v.length; V++)
        if (
          ((p(v[V].horizontalAlign) && "center" === this.horizontalAlign) ||
            v[V].horizontalAlign === this.horizontalAlign) &&
          ((p(v[V].verticalAlign) && "top" === this.verticalAlign) ||
            v[V].verticalAlign === this.verticalAlign) &&
          !v[V].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  var Ia = !1,
    ...
    Ga = v ? "Impact, Charcoal, sans-serif" : "Arial",
    Ca = {
      colorSet1:
  ...
  var hb = (function () {
    ...
    Da = (function () {
      ...
      return function (A, H, P) {
        ...
        "UTC:" === H.slice(0, 4) && ((H = H.slice(4)), (K = !0));
        P = K ? "getUTC" : "get";
        var Z = A[P + "Date"](),
          N = A[P + "Day"](),
          Y = A[P + "Month"](),
    ...
    ga = function (d, l, p) {
        ...
        if (((l = A[N]), "." === l && 0 > H)) H = N;
          ...
          if ("%" === l) D *= 100;
            ...
            ("E" !== l[0] && "e" !== l[0]) ||
              ...
              (U = !0);
          0 > H
            ? (P.push(l), "#" === l || "0" === l ? O++ : "," === l && I++)
            : (S.push(l), ("#" !== l && "0" !== l) || K++);
        }
      U &&
        ((l = Math.floor(d)),
        (A = -Math.floor(Math.log(d) / Math.LN10 + 1)),
        (Z = 0 === d ? 0 : 0 === l ? -(O + A) : ob(l).length - O),
        (D /= Math.pow(10, Z)));
      0 > H && (H = N);
      D = (d * D).toFixed(K);
      l = D.split(".");
      ...
      d = (l[1] + "").split("");
      D && "0" === D[0] && D.shift();
      for (U = A = N = K = H = 0; 0 < P.length; )
        if (((l = P.pop()), "#" === l || "0" === l))
          if ((H++, H === O)) {
            var Y = D,
              D = [];
            if ("0" === l)
              for (l = O - K - (Y ? Y.length : 0); 0 < l; ) Y.unshift("0"), l--;
            for (; 0 < Y.length; )
              (p = Y.pop() + p),
                U++,
                0 === U % A && N === I && 0 < Y.length && (p = t + p);
          } else
            0 < D.length
              ? ((p = D.pop() + p), K++, U++)
              : "0" === l && ((p = "0" + p), K++, U++),
              0 === U % A && N === I && 0 < D.length && (p = t + p);
        else
          ("E" !== l[0] && "e" !== l[0]) ||
          "0" !== l[l.length - 1] ||
          !/[eE][+-]*[0]+/.test(l)
            ? "," === l
              ? (N++, (A = U), (U = 0), 0 < D.length && (p = t + p))
              : (p =
                  1 < l.length &&
                  (('"' === l[0] && '"' === l[l.length - 1]) ||
                    ("'" === l[0] && "'" === l[l.length - 1]))
    ...
    Oa = 1,
    ma = cb ? Ua / Oa : 1,
    ba = function (d, l, p, v, t, A, D, H, U, P, O, S, K) {
  ...
  Z.prototype.updateOption = function (d) {
    ...
    this.theme && p(this.parent) && p(A) && p(H)
      ...
      : this.parent &&
        this.parent.themeOptions &&
        (this.options.theme && Pa[this.options.theme]
          ? (v = Pa[this.options.theme])
    ...
    if (0 === this.frontSize) A = t = 0;
      ...
      for (; 0 < d.length; ) {
        ...
        var I = A,
          ...
          t = t + D.height,
          d = Ha(d.slice(D.text.length, d.length));
  ...
  var Ra = {
    ...
    formatNumber: function (d, p, v) {
      v = v || "en";
      if (La[v]) return ga(d, p || "#,##0.##", new Ka(v));
  ...
  t = Ra.Chart = (function () {
    ...
    function A(a, e, c, b, f, h, r, x, J, k) {
      var m = 0;
      ...
      a.beginPath();
      J && 0 < x.thickness
        ? (a.moveTo(b - r.thickness / 2, Math.round((c + f) / 2) - q),
          a.lineTo(e + r.thickness / 2, Math.round((c + f) / 2) - q))
        : 0 < x.thickness &&
          (a.moveTo(Math.round((e + b) / 2) - q, c + r.thickness / 2),
    ...
    function S(a, e) {
      S.base.constructor.call(this, "Legend", "legend", e, null, a);
      this.chart = a;
        ...
        for (e = 0; e < this.plotInfo.plotTypes.length; e++)
          for (
            ...
            this.animatedRender &&
              ...
              (f = x.targetCanvasCtx.miterLimit),
            ...
            this.animatedRender &&
              ((x.targetCanvasCtx.miterLimit = f), J && c.push(J));
          }
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement)
            var s = a.axisX.sessionVariables.newViewportMinimum
              ...
              z = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (n.dataPoints[g].x && n.dataPoints[g].x.getTime) ||
            "dateTime" === n.xValueType
          )
            h = !0;
          for (g = 0; g < n.dataPoints.length; g++) {
            "undefined" === typeof n.dataPoints[g].x &&
              (n.dataPoints[g].x = g + (a.axisX.logarithmic ? 1 : 0));
            n.dataPoints[g].x.getTime
              ? ((h = !0), (b = n.dataPoints[g].x.getTime()))
              : (b = n.dataPoints[g].x);
            ...
            if (0 < g) {
              if (a.axisX.logarithmic) {
                ...
                (u = b - n.dataPoints[g - 1].x),
                  0 > u && (u *= -1),
                  c.minDiff > u && 0 !== u && (c.minDiff = u);
              null !== f &&
                null !== n.dataPoints[g - 1].y &&
                (a.axisY.logarithmic
                  ? 0 < f &&
                    ((u = f / n.dataPoints[g - 1].y),
                    1 > u && (u = 1 / u),
            ...
            if (b < s && !d) null !== n.dataPoints[g].y && (y = b);
            else {
              if (!d && ((d = !0), 0 < g)) {
                g -= 2;
                continue;
              ...
              n.dataPoints[g].label &&
                (a.axisX.labels[b] = n.dataPoints[g].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === n.dataPoints[g].y
                ? c.viewPortMin === b && y < b && (c.viewPortMin = y)
                : ((m[b] = (m[b] || 0) + n.dataPoints[g].y),
                  (n.dataPointEOs[g].cumulativeY = m[b]),
                  ...
                  0 <= f
                    ? r[b]
                      ? (r[b] += f)
                      : ((r[b] = f), (J = Math.min(f, J)))
                    : x[b]
                    ? (x[b] += f)
                    : ((x[b] = f), (k = Math.max(f, k))));
            }
          }
          a.axisY.scaleBreaks &&
        ...
        for (g in r)
          r.hasOwnProperty(g) &&
            !isNaN(g) &&
            ((a = r[g]),
            a < e.min && (e.min = Math.min(a, J)),
            a > e.max && (e.max = a),
            g < c.viewPortMin ||
              g > c.viewPortMax ||
              (a < e.viewPortMin && (e.viewPortMin = Math.min(a, J)),
          ...
          for (n = 0; n < q.dataPoints.length; n++) {
            ...
            if (0 < n) {
              ...
              p(f) ||
                ...
                (a.axisY.logarithmic
                  ? 0 < f &&
                    ((z = f / q.dataPoints[n - 1].y),
                    1 > z && (z = 1 / z),
                    e.minDiff > z && 1 !== z && (e.minDiff = z))
                  : ((z = f - q.dataPoints[n - 1].y),
                    0 > z && (z *= -1),
                    e.minDiff > z && 0 !== z && (e.minDiff = z)));
            }
            if (b < y && !g) null !== f && (w = b);
            else {
              if (!g && ((g = !0), 0 < n)) {
            ...
            !0 === x.dataPoints[d].isCumulativeSum
              ...
              : ((f =
                ...
                (x.dataPointEOs[d].cumulativeSumYStartValue =
                  0 === d ? 0 : x.dataPointEOs[d - 1].cumulativeSum),
                (x.dataPointEOs[d].cumulativeSum =
                  0 === d ? f : x.dataPointEOs[d - 1].cumulativeSum + f),
                (b += f));
          for (d = 0; d < x.dataPoints.length; d++)
            if (
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              x.dataPointEOs[d].cumulativeSum < e.min &&
                (e.min = x.dataPointEOs[d].cumulativeSum),
              x.dataPointEOs[d].cumulativeSum > e.max &&
                (e.max = x.dataPointEOs[d].cumulativeSum),
              0 < d &&
                (a.axisX.logarithmic
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < d &&
                (x.dataPointEOs[d - 1].cumulativeSum < e.viewPortMin &&
                  (e.viewPortMin = x.dataPointEOs[d - 1].cumulativeSum),
                x.dataPointEOs[d - 1].cumulativeSum > e.viewPortMax &&
                  (e.viewPortMax = x.dataPointEOs[d - 1].cumulativeSum));
              x.dataPointEOs[d].cumulativeSum < e.viewPortMin &&
                (e.viewPortMin = x.dataPointEOs[d].cumulativeSum);
              x.dataPointEOs[d].cumulativeSum > e.viewPortMax &&
                (e.viewPortMax = x.dataPointEOs[d].cumulativeSum);
            }
          x.axisX.valueType = x.xValueType = h ? "dateTime" : "number";
        }
    };
                    ...
                    if (
                      ...
                      for (var l = 0; l < h.length; l++)
                        (n = Math.floor((h[l] - m) / v)),
                          h[l] < g[n].min && (g[n].min = h[l]),
                          h[l] > g[n].max && (g[n].max = h[l]);
                    else
                      p(h) ||
                        ((n = Math.floor((h - m) / v)),
                        h < g[n].min && (g[n].min = h),
    ...
    l.prototype.renderCrosshairs = function (a) {
      for (var e = 0; e < this.axisX.length; e++)
        this.axisX[e] != a &&
          ...
          !this.axisX[e].crosshair._hidden &&
          this.axisX[e].showCrosshair(this.axisX[e].crosshair._updatedValue);
      for (e = 0; e < this.axisX2.length; e++)
        this.axisX2[e] != a &&
          this.axisX2[e].crosshair &&
          this.axisX2[e].crosshair.enabled &&
          !this.axisX2[e].crosshair._hidden &&
      ...
      for (e = 0; e < this.axisY.length; e++)
        this.axisY[e] != a &&
          ...
          !this.axisY[e].crosshair._hidden &&
          this.axisY[e].showCrosshair(this.axisY[e].crosshair._updatedValue);
      for (e = 0; e < this.axisY2.length; e++)
        this.axisY2[e] != a &&
          this.axisY2[e].crosshair &&
          this.axisY2[e].crosshair.enabled &&
          !this.axisY2[e].crosshair._hidden &&
          this.axisY2[e].showCrosshair(this.axisY2[e].crosshair._updatedValue);
    };
    ...
    l.prototype.getObjectAtXY = function (a, e, c) {
      ...
      else if (v) b = bb(a, e, this._eventManager.ghostCtx);
      else
        ...
        l.capturedEventParam &&
          ...
          f.hasOwnProperty(b) &&
            ("mouseup" !== b || f.chart.overlaidCanvas.releaseCapture
              ? (a.target !== f.chart.overlaidCanvas && v) ||
    ...
    l.prototype.validateRegion = function (a, e, c, b, f) {
      ...
      for (r = 0; r < k.length; r++) {
        var q = k[r],
          h = !1,
          n = q.convertPixelToValue({ x: a, y: e }),
        ...
        if (q.scaleBreaks)
          for (p = 0; !h && p < q.scaleBreaks._appliedBreaks.length; p++)
            h =
              ...
              q.scaleBreaks._appliedBreaks[p].endValue >= g;
        if (isFinite(q.dataInfo.minDiff))
          if (
            ((p = q.getApparentDifference(n, g, null, !0)),
            !(
              h ||
              (!(
                this.panEnabled &&
            ...
            d.push(q), m.push({ val1: n, val2: g }), (x = !0);
          else if (!f) {
            x = !1;
            break;
          }
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (null !== B && "" !== B) {
          var u = na("indexLabelPlacement", m.dataPoint, m.dataSeries),
            ...
            C = na("indexLabelTextAlign", m.dataPoint, m.dataSeries),
            t = m.direction,
            f = m.dataSeries.axisX,
          ...
          if ("stackedarea100" === q) {
            ...
            if (
              m.dataPoint.x < f.viewportMinimum ||
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            if ("inside" !== u)
              (f = c.y1),
                (h = c.y2),
                0 < t
                  ? ((g = m.point.y + w._lineHeight / 2 - k - x - b),
                    g < f &&
                      ((g =
                        "auto" === u
                          ? Math.max(m.point.y, f) + w._lineHeight / 2 + x + b
                          : f + w._lineHeight / 2 + x + b),
                      (A =
                      ...
                      !A ||
                        ...
                        0 <= q.indexOf("area") ||
                        (g -= b)))
                  : ((g = m.point.y + w._lineHeight / 2 + x + b),
                    g > h - k + w._lineHeight / 2 - x &&
                      ((g =
                        "auto" === u
              ...
              if (0 < t) {
                if (((g = b), "bubble" === q || "scatter" === q))
                  (g = m.point.y - k / 2 + w._lineHeight / 2),
                    k > m.bounds.y2 - m.bounds.y1 && (g -= k / 2 + x),
                    0 > g - w._lineHeight / 2 &&
                      (g +=
                ...
                (g = Math.min(m.point.y, b)),
                  g > h - k - x &&
                    ("bubble" === q || "scatter" === q) &&
                    (g = Math.min(m.point.y + x, c.y2 - k - x));
              g = Math.min(g, h);
            }
          } else
            0 <= q.indexOf("line") ||
          ...
          z &&
            ...
            e.setLineDash && e.setLineDash(H(y, z)),
            e.beginPath(),
                  ...
                  s < m.length - 1 &&
                    ...
                    c.setLineDash &&
                      (m[s].lineDashType
                        ...
                        : ((q = k.lineDashType), c.setLineDash(g))));
                  if (
                    0 !== m[s].markerSize &&
                    (0 < m[s].markerSize || 0 < k.markerSize)
                  ) {
                    var C = k.getMarkerProperties(s, l, u, c);
                    h.push(C);
                    B = O(B);
                    v &&
                      h.push({
              ...
              if (
                ...
                if ("number" !== typeof m[l].y)
                  ...
                  if (
                    ...
                    var B = k.getMarkerProperties(l, s, z, b);
                    r.push(B);
                    E = O(E);
                    v &&
                      r.push({
    ...
    l.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < p.length)
            for (
              var l = 5 < q && g.bevelEnabled ? !0 : !1, h = 0;
              h < p.length;
              h++
            )
              if (
              ...
              if (
                ...
                d = a.axisX.reversed
                  ...
                  : (d -
                      ...
                      (a.previousDataSeriesCount + m) * q) <<
                    0;
                var y = a.axisX.reversed ? (d - q) << 0 : (d + q) << 0,
                  s;
                0 <= l[h].y ? (s = k) : ((s = r), (r = k));
                b = l[h].color
                  ? l[h].color
                ...
                ba(
                  ...
                  a.axisX.reversed ? y : d,
                  a.axisY.reversed ? s : r,
                  a.axisX.reversed ? d : y,
                  b,
                  0,
                  null,
                  w,
    ...
    l.prototype.renderArea = function (a) {
      ...
      function b() {
        B &&
          ...
          h.fill(),
          (h.globalAlpha = 1),
          v && (r.lineTo(y, E), r.lineTo(B.x, E), r.closePath(), r.fill()),
          h.beginPath(),
          h.moveTo(y, s),
          r.beginPath(),
          r.moveTo(y, s),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          var w = 0,
            ...
            B = null;
          if (0 < l.length) {
            var C = g._colorSet[w % g._colorSet.length],
              t = (g.lineColor = g.options.lineColor || C),
              A = t;
            h.fillStyle = C;
            h.strokeStyle = t;
                ...
                if ("number" !== typeof l[w].y)
                  ...
                  w < l.length - 1 &&
                    ...
                    h.setLineDash &&
                      (l[w].lineDashType
                        ? ((c = l[w].lineDashType),
                          h.setLineDash(H(c, g.lineThickness)))
                        : ((c = g.lineDashType), h.setLineDash(Q))));
          ...
          if (0 < q.length) {
            ...
            if (b.setLineDash) {
              var A = H(m.nullDataLineDashType, m.lineThickness),
                C = m.lineDashType,
                D = H(C, m.lineThickness);
              b.setLineDash(D);
            }
            for (l = !1; n < q.length; n++)
              if (
                ((g = q[n].x.getTime ? q[n].x.getTime() : q[n].x),
                !(
                ...
                if ("number" !== typeof q[n].y)
                  ...
                  n < q.length - 1 &&
                    (B !== (q[n].lineColor || E) ||
                      C !== (q[n].lineDashType || m.lineDashType)) &&
                    ((B = q[n].lineColor || E),
                  ...
                  if (
                    ...
                    var Q = m.getMarkerProperties(n, g, l, b);
                    r.push(Q);
                    L = O(L);
                    v &&
                      r.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          if (0 < l.length) {
            ...
            var L = "solid";
            if (h.setLineDash) {
              var Q = H(g.nullDataLineDashType, g.lineThickness),
                L = g.lineDashType,
                D = H(L, g.lineThickness);
              h.setLineDash(D);
            }
            for (; w < l.length; w++)
              if (
                ...
                "number" !== typeof l[w].y
                  ...
                  : ((y = a.axisX.convertValueToPixel(z)),
                    ...
                    w < l.length - 1 &&
                      (A !== (l[w].lineColor || t) ||
                        L !== (l[w].lineDashType || g.lineDashType)) &&
                      (b(),
                      (A = l[w].lineColor || t),
                      (h.strokeStyle = A),
                      h.setLineDash &&
                        (l[w].lineDashType
                          ? ((L = l[w].lineDashType),
                            h.setLineDash(H(L, g.lineThickness)))
                          : ((L = g.lineDashType), h.setLineDash(D)))),
                    (z = g.dataPointIds[w]),
                    ...
                    0 !== l[w].markerSize &&
                      (0 < l[w].markerSize || 0 < g.markerSize) &&
                      ((aa = g.getMarkerProperties(w, y, s, h)),
                      p.push(aa),
                      (z = O(z)),
                      v &&
                        p.push({
    ...
    l.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], E = 0; E < a.dataSeriesIndexes.length; E++) {
          var B = a.dataSeriesIndexes[E],
            C = this.data[B],
            t = C.dataPoints;
          C.dataPointIndexes = [];
          for (n = 0; n < t.length; n++)
            (B = t[n].x.getTime ? t[n].x.getTime() : t[n].x),
              (C.dataPointIndexes[B] = n),
              f[B] || (m.push(B), (f[B] = !0));
          m.sort(Ta);
        }
        for (E = 0; E < a.dataSeriesIndexes.length; E++) {
          ...
          if (0 < m.length) {
            var f = C._colorSet[0],
              A = (C.lineColor = C.options.lineColor || f),
              L = A;
            b.fillStyle = f;
            b.strokeStyle = A;
            ...
            for (var aa = !0, n = 0; n < m.length; n++) {
              ...
              if (
                ...
                if ("number" !== typeof ha.y)
                  ...
                  n < t.length - 1 &&
                    (L !== (t[n].lineColor || A) ||
                      u !== (t[n].lineDashType || C.lineDashType)) &&
                    (e(),
                    b.beginPath(),
                    b.moveTo(g, l),
                    k.push({ x: g, y: w - pa }),
                    ...
                    b.setLineDash &&
                      (t[n].lineDashType
                        ? ((u = t[n].lineDashType),
                          b.setLineDash(H(u, C.lineThickness)))
                        : ((u = C.lineDashType), b.setLineDash(D))));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          for (n = 0; n < A.length; n++)
            (B = A[n].x.getTime ? A[n].x.getTime() : A[n].x),
              (C.dataPointIndexes[B] = n),
              f[B] || (m.push(B), (f[B] = !0));
          m.sort(Ta);
        }
        for (t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          k = [];
          if (0 < m.length) {
            var f = C._colorSet[n % C._colorSet.length],
              D = (C.lineColor = C.options.lineColor || f),
              L = D;
            b.fillStyle = f;
            b.strokeStyle = D;
            b.lineWidth = C.lineThickness;
            ...
            for (var aa = !0, n = 0; n < m.length; n++) {
              ...
              if (
                ...
                if ("number" !== typeof ha.y)
                  ...
                  y || aa
                    ? (!y && C.connectNullData
                        ? (b.setLineDash &&
                            ...
                            k.push(s),
                            k.push(y),
                            (s = C.nullDataLineDashType),
                            b.setLineDash(Q)),
                          b.lineTo(g, l),
                          v && u.lineTo(g, l))
                        : (b.beginPath(),
                          b.moveTo(g, l),
                          v && (u.beginPath(), u.moveTo(g, l))),
                      (aa = y = !1))
                    : (b.lineTo(g, l),
                      v && u.lineTo(g, l),
                      0 == n % 250 &&
                  ...
                  n < A.length - 1 &&
                    (L !== (A[n].lineColor || D) ||
                      s !== (A[n].lineDashType || C.lineDashType)) &&
                    (e(),
                    b.beginPath(),
                    b.moveTo(g, l),
                    k.push({ x: g, y: z - la }),
                    ...
                    b.setLineDash &&
                      (A[n].lineDashType
                        ? ((s = A[n].lineDashType),
                          b.setLineDash(H(s, C.lineThickness)))
                        : ((s = C.lineDashType), b.setLineDash(fa))));
                  if (0 <= C.dataPointIndexes[h]) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          for (
            ...
            (h = n[f].getTime ? (h = n[f].x.getTime()) : (h = n[f].x)),
              h < a.axisX.dataInfo.viewPortMin ||
                h > a.axisX.dataInfo.viewPortMax ||
                "undefined" === typeof n[f].z ||
                ((g = n[f].z), g > d && (d = g), g < p && (p = g));
        for (
          var l = 25 * Math.PI,
            w = Math.max(
              ...
              if (
                ...
                (z[d].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: z[d],
                    dataSeries: s,
                    point: { x: E + (B - E) / 2, y: a.axisY.reversed ? q : m },
                    direction: 1,
                    bounds: {
                      x1: E,
                      y1: Math.min(m, q),
              ...
              if (
                ...
                (u[r].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: u[r],
                    dataSeries: z,
                    point: { x: B + (C - B) / 2, y: a.axisY.reversed ? l : q },
                    direction: 1,
                    bounds: {
                      x1: B,
                      y1: Math.min(l, q),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
          ...
          d = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (C ? y : 1))
              ) << 0
            : 0.3 * this.width;
          h &&
            (d = this.options.dataPointMaxWidth
          ...
          s > d && (s = d);
          if (0 < B.length)
            for (var H = E._colorSet, d = 0; d < B.length; d++) {
              var f = (E.lineColor = E.options.color ? E.options.color : H[0]),
                L = {
              ...
              if (
                ...
                b ? (k = fa) : (l = fa);
                fa = a.axisY.convertValueToPixel(B[d].y[0]);
                b ? (m = fa) : (n = fa);
                fa = a.axisY.convertValueToPixel(B[d].y[1]);
                b ? (q = fa) : (g = fa);
                b
                  ? ((n = a.axisX.reversed
                      ? (k + ((C ? y : 1) * s) / 2 - (C ? D - 1 : 0) * s) << 0
                      : (k - ((C ? y : 1) * s) / 2 + (C ? D - 1 : 0) * s) << 0),
                    (g = a.axisX.reversed ? (n - s) << 0 : (n + s) << 0))
                  : ((m = a.axisX.reversed
                      ? (l + ((C ? y : 1) * s) / 2 - (C ? D - 1 : 0) * s) << 0
                      : (l - ((C ? y : 1) * s) / 2 + (C ? D - 1 : 0) * s) << 0),
                ...
                v && A(this._eventManager.ghostCtx, m, n, q, g, f, L, Q, b);
                if (
                  B[d].indexLabel ||
                  E.indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: b ? (B[d].y[1] >= B[d].y[0] ? m : q) : m + (q - m) / 2,
                      y: b ? n + (g - n) / 2 : B[d].y[1] >= B[d].y[0] ? g : n,
                    },
                      ...
                      point: {
                        x: b
                          ? B[d].y[1] >= B[d].y[0]
                            ...
                            : m
                          : m + (q - m) / 2,
                        y: b ? n + (g - n) / 2 : B[d].y[1] >= B[d].y[0] ? n : g,
                      },
                      direction: B[d].y[1] >= B[d].y[0] ? 1 : -1,
                      bounds: {
                        x1: b ? Math.min(m, q) : m,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
          ...
          if (0 < q.length) {
            ...
            for (var L = !0; g < q.length; g++)
              if (
                ((s = q[g].x.getTime ? q[g].x.getTime() : q[g].x),
                !(
                  s < a.axisX.dataInfo.viewPortMin ||
                  (s > a.axisX.dataInfo.viewPortMax &&
                    (!m.connectNullData || !L))
                ...
                if (
                  ...
                  g < q.length - 1 &&
                    (B !== (q[g].lineColor || t) ||
                      C !== (q[g].lineDashType || m.lineDashType)) &&
                    (e(),
                    (B = q[g].lineColor || t),
                  ...
                  if (
                    0 !== q[g].markerSize &&
                    (0 < q[g].markerSize || 0 < m.markerSize)
                  ) {
                    var Q = m.getMarkerProperties(g, l, y, b);
                    h.push(Q);
                    var fa = O(s);
                    v &&
                      h.push({
                    ...
                    Q = m.getMarkerProperties(g, l, w, b);
                    h.push(Q);
                    fa = O(s);
                    v &&
                      h.push({
        ...
        for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
          ...
          if (0 < m.length) {
            ...
            var E = "solid",
              B;
            if (b.setLineDash) {
              var C = H(k.nullDataLineDashType, k.lineThickness),
                E = k.lineDashType;
              B = H(E, k.lineThickness);
            }
            for (g = !1; q < m.length; q++)
              if (
    ...
    l.prototype.renderPie = function (a) {
      ...
      function c(a, b) {
        ...
        for (c = 0; c < m.length; c++) {
          var e = g[c].startAngle,
            f = g[c].endAngle;
          if (f > e) {
            var h = 0.07 * C * Math.cos(g[c].midAngle),
              d = 0.07 * C * Math.sin(g[c].midAngle),
              r = !1;
            if (m[c].exploded) {
              if (
          ...
          (f = g[e]),
            f.indexLabelText &&
              ...
              "inside" !== f.indexLabelPlacement &&
                ...
                ((h = f.center.x + C * Math.cos(f.midAngle)),
                (d = f.center.y + C * Math.sin(f.midAngle)),
                (c.strokeStyle = f.indexLabelLineColor),
                (c.lineWidth = f.indexLabelLineThickness),
                c.setLineDash &&
                  c.setLineDash(
                    H(f.indexLabelLineDashType, f.indexLabelLineThickness)
                  ),
                c.beginPath(),
                c.moveTo(h, d),
                c.lineTo(f.indexLabelTextBlock.x, f.indexLabelTextBlock.y),
                c.lineTo(
                  f.indexLabelTextBlock.x + ("left" === f.hemisphere ? -q : q),
                  f.indexLabelTextBlock.y
                ),
                c.stroke()),
              (c.lineJoin = "miter"));
      ...
      function b(a, b) {
        ...
        return (c =
          b.indexLabelTextBlock.y > a.indexLabelTextBlock.y ? g - f : c - e);
      }
      function f(a) {
        ...
        if (0 <= a && a < m.length) {
          ...
          r =
            "right" === n.hemisphere
              ...
              : u.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - u.y, 2));
          p = u.x + C * Math.cos(n.midAngle);
          q = u.y + C * Math.sin(n.midAngle);
      ...
      function r() {
        ...
        for (
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (var p, s, a = 0; a < m.length; a++) {
              ...
              if (null !== x) {
                ...
                var t = 0,
                  t = b(p, s) - v;
                if (0 > t) {
                  for (var B = (s = 0), E = 0; E < m.length; E++)
                    E !== a &&
                      g[E].hemisphere === r.hemisphere &&
                      (g[E].indexLabelTextBlock.y < r.indexLabelTextBlock.y
                        ? s++
                        : B++);
                  s = (t / (s + B || 1)) * B;
                  var B = -1 * (t - s),
            ...
            for (a = 0; a < m.length; a++)
              (r = g[a]),
                ...
                (s = u.y + w * Math.sin(r.midAngle)),
                (r.indexLabelTextBlock.x = x),
                (r.indexLabelTextBlock.y = s);
          for (a = 0; a < m.length; a++)
            if (
              ((r = g[a]),
              (x = r.indexLabelTextBlock.measureText()),
              ...
              (x = x = 0),
                ...
                0 < x &&
                  (!d &&
                    ...
                    ((s =
                      "right" === r.hemisphere
                        ? n.x2 - r.indexLabelTextBlock.x
                        : r.indexLabelTextBlock.x - n.x1),
                  ...
                  ((x /= Math.abs(Math.cos(r.indexLabelAngle))),
                  9 < x && (x *= 0.3),
                  x > e && (e = x)),
                (x = x = 0),
                  ...
                  (!d &&
                    ...
                    ((s =
                      0 < r.indexLabelAngle && r.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === h(a, x * s) && h(a, 2 * s)),
                  Math.abs(r.indexLabelTextBlock.x - u.x) < C &&
                    ((x /= Math.abs(Math.sin(r.indexLabelAngle))),
                    9 < x && (x *= 0.3),
                    x > e && (e = x)));
          ...
          (function () {
            for (var a = -1, c = -1, e = 0, h = !1, r = 0; r < m.length; r++)
              if (((h = !1), (p = g[r]), p.indexLabelText)) {
                var d = f(r);
                if (null !== d) {
                  var k = g[d];
                  t = 0;
    ...
    l.prototype.renderFunnel = function (a) {
      ...
      function f() {
        ...
        for (
          ...
          c = G[d];
          f = c.textBlock;
          b = (a = n(d) < R.length ? G[n(d)] : null) ? a.textBlock : null;
          c = c.height;
          a && f.y + c + ea > b.y && (e = !0);
        ...
        if (e)
          for (d = G.length - 1; 0 <= d; d--)
            (a = R[d]),
              (G[d].textBlock.maxWidth = g[g.length - (d + 1)]),
              G[d].textBlock.measureText(),
              (G[d].textBlock.height =
                G[d].textBlock.height === 2 * G[d].textBlock.padding
                  ? 0
                  : G[d].textBlock.height),
              (G[d].textBlock.width =
                G[d].textBlock.width === 2 * G[d].textBlock.padding
                  ? 0
                  : G[d].textBlock.width),
              (G[d].textBlock.x = K - r),
              (c =
                G[d].textBlock.height < G[d].textBlock.maxHeight
                  ? G[d].textBlock.height
                  : G[d].textBlock.maxHeight),
              (e =
                G[d].textBlock.width < G[d].textBlock.maxWidth
                  ? G[d].textBlock.width
                  : G[d].textBlock.maxWidth),
              (G[d].height = c),
              (G[d].width = e),
              (c =
              ...
              s.reversed
                ? (G[d].textBlock.y + G[d].height > V + A &&
                    (G[d].textBlock.y = V + A - G[d].height),
                  G[d].textBlock.y < ua - A && (G[d].textBlock.y = ua - A))
                : (G[d].textBlock.y < V - A && (G[d].textBlock.y = V - A),
                  G[d].textBlock.y + G[d].height > ua + A &&
                    (G[d].textBlock.y = ua + A - G[d].height));
      }
      function h() {
        var a, b, c, f;
          ...
          for (var e = 0; e < R.length; e++)
            0 == G[e].textBlock.text.length
              ...
              : ((a = R[e]),
                ...
                s.reversed
                  ? (G[e].textBlock.y + G[e].height > V + A &&
                      (G[e].textBlock.y = V + A - G[e].height),
                    G[e].textBlock.y < ua - A && (G[e].textBlock.y = ua - A))
                  : (G[e].textBlock.y < V - A && (G[e].textBlock.y = V - A),
                    G[e].textBlock.y + G[e].height > ua + A &&
                      (G[e].textBlock.y = ua + A - G[e].height)));
        else
      ...
      function r() {
        ...
        function b() {
          ...
          for (var d, k = 1; k < r; k++) {
            ...
            for (var p = G.length - 1; 0 <= p; p--)
              !G[p].isDirty &&
                ...
                ((d = n(p)),
                !(d >= G.length - 1) &&
                  G[p].textBlock.y + G[p].height + ea > G[d].textBlock.y &&
                  (G[p].textBlock.y =
          ...
          for (d = R.length - 1; 0 < d; d--)
            if (!G[d].isDirty) {
              ...
              if (G[d].textBlock.y < G[f].textBlock.y + G[f].height) {
                e = e || d;
                g = d;
                for (
                  r = 0;
                  G[g].textBlock.y < G[f].textBlock.y + G[f].height + ea;
        ...
        for (var e, f, g, h, r, k, m = 1, p = 0; p < 2 * m; p++) {
          for (
            ...
            (g = G[l]),
            (h = g.textBlock),
            (k = (r = n(l) < R.length ? G[n(l)] : null) ? r.textBlock : null),
            (e = +g.height.toFixed(6)),
            (f = +h.y.toFixed(6)),
            !g.isDirty &&
              r &&
              f + e + ea > +k.y.toFixed(6) &&
              ((e = h.y + e + ea - k.y),
              (f = a(l, -e)),
              f < e && (0 < f && (e -= f), (f = a(n(l), e)), f != e)));
            l--
          );
          b();
        }
      ...
      function d(a, b) {
        return (
          (b < R.length ? G[b].textBlock.y : s.reversed ? V + A : ua + A) -
          (0 > a
            ? s.reversed
              ? ua - A
              : V - A
            : G[a].textBlock.y + G[a].height + ea)
        );
      }
      function l(a, b, c) {
        var e,
        ...
        a._animator.animate(
          ...
          function (c) {
            ...
            for (f = 0; f < R.length; f++) ra(e, R[f], s.fillOpacity);
            w(e);
            L && ("inside" !== s.indexLabelPlacement ? m(e) : h(), t(e));
            1 <= c && (ia = !1);
          },
          null,
      ...
      function m(a) {
        for (var b, c, e, f, h = 0; h < R.length; h++)
          (f = 1 === G[h].lineThickness % 2 ? 0.5 : 0),
            (c = (((R[h].y2 + R[h].y4) / 2) << 0) + f),
            (b = g(c).x2 - 1),
            (e = G[h].textBlock.x),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var s = this.data[a.dataSeriesIndexes[0]],
            ...
            C = 0,
            D = u.height - 2 * A,
            I = Math.min(u.width - 2 * B, 2.8 * u.height),
            L = !1,
            Q = 0;
          Q < z.length;
          Q++
        ...
        if (0 != s.length && s.dataPoints && s.visible && 0 !== z.length) {
          ...
          if (-1 !== Q) {
            if (s.reversed)
              for (I.push(ba), F = Q.length - 1; 0 < F; F--)
                (ba += Q[F]), I.push(ba);
            else for (F = 0; F < Q.length; F++) (ba += Q[F]), I.push(ba);
            if (s.reversed)
              for (F = 0; F < Q.length; F++)
                I[F] < Y
                  ? (a.push(M), B.push($), (da = F))
                  : (a.push((I[F] - V + ca * W) / ca),
                    B.push((I[F] - V + ga * Z) / ga));
            else
              for (F = 0; F < Q.length; F++)
                I[F] < Y
                  ? (a.push((I[F] - V + ca * W) / ca),
            ...
            for (F = 0; F < z.length; F++)
              z[F].exploded &&
                ((Q = !0), s.reversed ? X.push(z.length - 1 - F) : X.push(F));
            ...
            for (F = 0; F < R.length; F++)
              (C = R[F]), ra(U, C, s.fillOpacity), ja.push(C.y1);
            w(U);
            L &&
              s.visible &&
              ("inside" === s.indexLabelPlacement || y.animationEnabled || m(U),
              y.animationEnabled || t());
            if (!L)
              for (F = 0; F < z.length; F++)
                (C = s.dataPointIds[F]),
                  (a = {
            ...
            return {
              ...
              animationCallback: function (a, b) {
                ...
                1 <= a && (l(y, -1, 500), w(y.plotArea.ctx || y.ctx));
              },
              easingFunction: N.easing.easeInQuad,
              animationBase: 0,
            };
      ...
      if (b && e && c) {
        ...
        if ("undefined" !== typeof Blob && new Blob()) {
          for (
            ...
            d[p] = r.charCodeAt(p);
          e = new Blob([d.buffer], { type: "image/" + e });
          try {
    ...
    l.prototype.replaceKeywordsWithValue = function (a, e, c, b, f) {
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        try {
          var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
          g && 0 < g.length && ((r = Ha(g[2])), (a = Ha(g[1])));
        } catch (d) {}
        g = null;
        if ("color" === a)
            ...
            var n = (q.legendMarkerType = q.legendMarkerType
                ...
                ? "error" === q.type && q._linkedSeries
                  ? q._linkedSeries.legendMarkerType
                    ? q._linkedSeries.legendMarkerType
                    : W.getDefaultLegendMarker(q._linkedSeries.type)
                  : W.getDefaultLegendMarker(q.type)
                : q.markerType),
              g = q.legendText
                ? q.legendText
                ...
                : q.name,
              v = (q.legendMarkerColor = q.legendMarkerColor
                ? q.legendMarkerColor
                : q.markerColor
                ? q.markerColor
                : "error" === q.type
            ...
            for (var z = 0; z < q.dataPoints.length; z++) {
              var u = q.dataPoints[z],
                ...
                s = u.legendMarkerBorderThickness
                  ...
                  ? Math.max(1, Math.round(0.2 * w))
                  : 0,
                g = this.chart.replaceKeywordsWithValue(g, u, q, z),
                n = {
                  markerType: n,
                  markerColor: v,
                  text: g,
    ...
    S.prototype.render = function () {
      ...
      for (var d = 0, p = 0; p < r.length; p++) {
        for (var k = r[p], m = 0, q = 0; q < k.items.length; q++) {
          ...
          n.textBlock.y = Math.round(l + this.lineHeight / 2);
          ...
          if (n) {
            switch (this.type) {
              ...
              case "rangeSplineArea":
                ...
                y = c ? 20 : w;
                t = Math.min(
                  Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y1 - e, 2)),
                  Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y2 - e, 2))
                );
                t <= y &&
                  b.push({
                    dataPoint: g,
              ...
              case "boxAndWhisker":
                if (
                  (a >= n.x1 - n.borderThickness / 2 &&
                    ...
                    e >= n.y4 - n.borderThickness / 2 &&
                    e <= n.y1 + n.borderThickness / 2) ||
              ...
              case "candlestick":
                if (
                  (a >= n.x1 - n.borderThickness / 2 &&
                    a <= n.x2 + n.borderThickness / 2 &&
                    e >= n.y2 - n.borderThickness / 2 &&
                    e <= n.y3 + n.borderThickness / 2) ||
                  (Math.abs(n.x2 - a + n.x1 - a) < n.borderThickness &&
                    e >= n.y1 &&
                    e <= n.y4)
                )
    ...
    D.setLayout = function (a, e, c, b, f, h) {
      ...
      for (g = 0; g < n.length; g++)
        if (n[g] && n[g].scaleBreaks && n[g].scaleBreaks._appliedBreaks.length)
          for (
            var v = n[g].scaleBreaks._appliedBreaks, w = 0;
            w < v.length && !(v[w].startValue > n[g].viewportMaximum);
            w++
          )
            v[w].endValue < n[g].viewportMinimum ||
              (p(n[g].scaleBreaks.firstBreakIndex) &&
                (n[g].scaleBreaks.firstBreakIndex = w),
              v[w].startValue >= n[g].viewPortMinimum &&
                (n[g].scaleBreaks.lastBreakIndex = w));
      for (
        var y = (w = 0),
          s = 0,
          z = 0,
        ...
        n[g] &&
          n[g].title &&
          (n[g]._titleTextBlock = new ka(n[g].ctx, {
            text: n[g].title,
            horizontalAlign: "center",
        ...
        if (n[g].title)
          switch (n[g]._position) {
            case "left":
              ...
              n[g]._titleTextBlock.maxHeight = n[g].titleWrap
                ? 0.8 * h.width
                : 1.5 * n[g].titleFontSize;
            ...
            case "right":
              ...
              break;
            default:
              (n[g]._titleTextBlock.maxWidth = n[g].titleMaxWidth || h.width),
                (n[g]._titleTextBlock.maxHeight = n[g].titleWrap
                  ? 0.8 * h.height
                  : 1.5 * n[g].titleFontSize),
      ...
      if ("normal" === f) {
        for (
          ...
          var F = 0,
            ...
            $ = 0;
          if (c && 0 < c.length)
            for (A = [], g = R = 0; g < c.length; g++)
              A.push(
                Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)
              ),
                (R += A[g]),
                (M += c[g] && !m.isNavigator ? c[g].margin : 0);
          else
            ...
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                !a[g] ||
                  ...
                  0 < a[g].labelAngle
                    ? D + s > t &&
                      (l += 0 < a[g].labelAngle ? D + s - t - $ : 0)
                    : 0 > a[g].labelAngle
                    ? C - y < d &&
                      C - y < a[g].viewportMinimum &&
                      (H =
                        d -
                        (M +
                          a[g].tickLength +
          ...
          if (e && 0 < e.length)
            for (g = 0; g < e.length; g++)
              (e[g].lineCoordinates.x1 = Math.round(h.x1 + R + M)),
              ...
              b[g] &&
                ...
                (M =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (l = Math.round(
                  h.y1 + Y + W < Math.max(M, q) ? Math.max(M, q) : h.y1 + Y + W
                )),
                (M =
                  0 < a.length
                    ? 0
          ...
          for (g = 0; g < n.length; g++)
            "axisY" === n[g].type &&
              (n[g].calculateValueToPixelConversionParameters(),
        ...
        N = [];
        for (P = []; 4 > w; ) {
          X = V = T = Z = M = W = f = S = O = F = Y = 0;
          if (a && 0 < a.length)
            for (H = [], g = V = 0; g < a.length; g++)
              H.push(
          ...
          if (m.panEnabled)
            for (g = 0; g < c.length; g++)
              q[g] = p(m.sessionVariables.axisY[g].height)
          ...
          if (c && 0 < c.length)
            for (g = c.length - 1; 0 <= g; g--)
              (l = Math.round(h.y2)),
                ...
                (c[g].lineCoordinates.y1 = l - (q[g] + c[g].margin + Y)),
                (c[g].lineCoordinates.y2 = l - (q[g] + c[g].margin + Y)),
                "inside" === c[g].labelPlacement &&
                  0 < g &&
          ...
          if (b && 0 < b.length)
            for (g = b.length - 1; 0 <= g; g--)
              b[g] &&
                ((l = Math.round(h.y1)),
                (k = Math.round(h.y1 + (C[g] + b[g].margin + F))),
            ...
            for (g = 0; g < e.length; g++) {
              ...
              if (b && 0 < b.length)
                for (M = 0; M < b.length; M++)
                  b[M] &&
                    b[M].labelAutoFit &&
                    ((t = b[M].lineCoordinates.x2), (d = t - X));
              e[g].lineCoordinates = {
                x1: t + S,
                y1: l,
                x2: t + S,
    ...
    D.render = function (a, e, c, b, f) {
      ...
      if (e && 0 < e.length)
        for (d = 0; d < e.length; d++)
          e[d].renderGrid(),
            v && (e[d].createMask(), e[d].renderBreaksBackground());
      if (c && 0 < c.length)
        for (d = 0; d < c.length; d++)
          c[d].renderGrid(),
      ...
      for (var a = 0; a < this.stripLines.length; a++)
        if (
          ...
          this.stripLines[a].value = this.convertPixelToValue(
            Math.abs(
              this.convertValueToPixel(e) + this.convertValueToPixel(c)
            ) / 2
          );
    ...
    D.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          e.setLineDash &&
            e.setLineDash(H(this.lineDashType, this.lineThickness));
          var d =
    ...
    D.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      d = Math.pow(
        this.logarithmBase,
        D.getNiceNumber(Math.abs(Math.log(d) / e), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = D.getNiceExponent(Math.log(d) / e / (a - 1), !0)),
          ...
          if (
            ...
            "top" === this.scaleBreaks.parent._position
              ...
              : ((f = this.chart.plotArea.y2),
                ...
                (a *= -1)),
            (this.bounds = { x1: b - q / 2, y1: f, x2: l + q / 2, y2: p }),
            this.ctx.moveTo(b, f),
            "straight" === this.type ||
              ("top" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("bottom" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(b, p), this.ctx.lineTo(l, p), this.ctx.lineTo(l, f);
          ...
          if (
            ...
            "left" === this.scaleBreaks.parent._position
              ...
              : ((b = this.chart.plotArea.x2),
                ...
                (a *= -1)),
            (this.bounds = { x1: b, y1: f - q / 2, x2: l, y2: p + q / 2 }),
            this.ctx.moveTo(b, f),
            "straight" === this.type ||
              ("left" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("right" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(l, f), this.ctx.lineTo(l, p), this.ctx.lineTo(b, p);
          else if ("wavy" === this.type) {
            t = b;
            k = f;
            d = 0.5;
      ...
      if (0 < e) {
        ...
        if (
          ...
          (f = d = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            ...
            (this.bounds = { x1: f - e / 2, y1: l, x2: d + e / 2, y2: p });
        else if (
          ...
          (l = p = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            ...
            (this.bounds = { x1: f, y1: l - e / 2, x2: d, y2: p + e / 2 });
        this.ctx.moveTo(f, l);
        this.ctx.lineTo(d, p);
        this.ctx.stroke();
      ...
      for (b = 0; b < e.axisX.length; b++)
        (a = e.axisX[b]._crosshairValue),
          e.axisX[b].crosshair &&
            ...
            (e.axisX[b].crosshair._updatedValue = a),
      ...
      for (b = 0; b < e.axisX2.length; b++)
        (a = e.axisX2[b]._crosshairValue),
          e.axisX2[b].crosshair &&
            ...
            (e.axisX2[b].crosshair._updatedValue = a),
      ...
      for (b = 0; b < e.axisY.length; b++)
        (a = e.axisY[b]._crosshairValue),
          e.axisY[b].crosshair &&
            ...
            (e.axisY[b].crosshair._updatedValue = a),
      ...
      for (b = 0; b < e.axisY2.length; b++)
        (a = e.axisY2[b]._crosshairValue),
          e.axisY2[b].crosshair &&
            ...
            (e.axisY2[b].crosshair._updatedValue = a),
    ...
    da.prototype.render = function (a, e, c) {
      ...
      if (this.snapToDataPoint) {
            ...
            if (
              ...
              if (m[s].dataPoint.y)
                for (E = 0; E < m[s].dataPoint.y.length; E++)
                  (z = Math.abs(
                    e - this.parent.convertValueToPixel(m[s].dataPoint.y[E])
                  )),
                    z <= w && ((w = z), (y = s));
            } else
        ...
        if (
          ...
          "top" === this.parent._position &&
            ...
            this.value >=
              ...
              0 < n &&
              (g.moveTo(b, d), g.lineTo(f, l), g.stroke(), (this._hidden = !1));
        if (
          "left" === this.parent._position ||
          "right" === this.parent._position
        )
        ...
        if (
          ...
          (b = f = t = 1 === g.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (d = this.chart.plotArea.y1),
            (l = this.chart.plotArea.y2),
            (this.bounds = { x1: b - n / 2, y1: d, x2: f + n / 2, y2: l });
        else if (
          ...
          (d = l = v = 1 === g.lineWidth % 2 ? (e << 0) + 0.5 : e << 0),
            (b = this.chart.plotArea.x1),
            (f = this.chart.plotArea.x2),
            (this.bounds = { x1: b, y1: d - n / 2, x2: f, y2: l + n / 2 });
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
      ...
      if (a && e) {
        ...
        "mouseout" !== e
          ...
          : ((c.target.style.cursor = this.chart.panEnabled
              ? "itemmouseout" !== d.mouseout || h.dockInsidePlotArea
                ? "move"
