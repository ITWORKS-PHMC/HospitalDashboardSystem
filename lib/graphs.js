(function () {
  ...
  function Ya(d, l, T) {
    "millisecond" === T
      ...
      : "year" === T && d.setFullYear(d.getFullYear() + 1 * l);
    return d;
  }
  function ca(d, l) {
    var T = !1;
  ...
  function za(d) {
    d.roundRect = function (d, T, p, v, ra, D, t, A) {
      ...
      this.beginPath();
      this.moveTo(d + ra, T);
      this.lineTo(d + p - ra, T);
      this.quadraticCurveTo(d + p, T, d + p, T + ra);
      this.lineTo(d + p, T + v - ra);
      this.quadraticCurveTo(d + p, T + v, d + p - ra, T + v);
  ...
  function H(d, l) {
    ...
    if (
      ...
      for (var v = 0; v < p.length; v++) p[v] *= l;
    else p = [];
    return p;
  }
  function K(d, l, T, v, $) {
    v = v || [];
    $ = p($) ? (gb ? { passive: !1, capture: !1 } : !1) : $;
    v.push([d, l, T, $]);
    return d.addEventListener
      ? (d.addEventListener(l, T, $), T)
      : d.attachEvent
      ? ((v = function (l) {
          l = l || window.event;
          l.preventDefault =
  ...
  function hb(d) {
    ...
    if (d.exportEnabled && d._dropdownMenu) {
      ...
      !d._dropdownMenu &&
        ...
        (p = -1 !== d.theme.indexOf("dark") ? "black" : "#888888"),
        O(d._dropdownMenu, {
          position: "absolute",
          zIndex: 1,
          userSelect: "none",
    ...
    v && bb
      ? ((ba =
          !p(ba) && ba
            ...
            : d.getContext("2d")),
        (Na =
          ba.webkitBackingStorePixelRatio ||
          ba.mozBackingStorePixelRatio ||
          ba.msBackingStorePixelRatio ||
          ba.oBackingStorePixelRatio ||
          ba.backingStorePixelRatio ||
          1),
        (ma = Ta / Na),
        (d.width = l * ma),
        (d.height = T * ma),
  ...
  function ib(d) {
    if (!jb) {
      ...
      "undefined" === typeof qa.Chart.creditHref
        ? ((d.creditHref = ja("")), (d.creditText = ja("")))
  ...
  function va(d, l, p) {
    ...
    v ||
      ...
      G_vmlCanvasManager.initElement(ba);
    return ba;
  }
  function O(d, l) {
  ...
  function ta(d, l, p) {
    ...
    l.getAttribute("state") !== p &&
      ...
      (l.innerHTML =
        ...
        "' />"),
      O(l.childNodes[0], { height: "95%", pointerEvents: "none" }));
  ...
  function Z(d, l, v, ba, $) {
    ...
    d = {};
    this.theme && p(this.parent) && p(l) && p(ba)
      ...
      : this.parent &&
        ...
        (null === ba
          ...
          : 0 < this.parent.themeOptions[l].length &&
            ((ba = Math.min(this.parent.themeOptions[l].length - 1, ba)),
            (d = this.parent.themeOptions[l][ba])));
    this.themeOptions = d;
  ...
  function Aa(d, l) {
    ...
    if (p(this.options.margin) && d.options.subtitles)
      for (var v = d.options.subtitles, ba = 0; ba < v.length; ba++)
        if (
          ((p(v[ba].horizontalAlign) && "center" === this.horizontalAlign) ||
            v[ba].horizontalAlign === this.horizontalAlign) &&
          ((p(v[ba].verticalAlign) && "top" === this.verticalAlign) ||
            v[ba].verticalAlign === this.verticalAlign) &&
          !v[ba].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  function Ia(d, l, p) {
    Ia.base.constructor.call(this, "Subtitle", "subtitles", l, p, d);
    this.chart = d;
    this.canvas = d.canvas;
    this.ctx = this.chart.ctx;
  ...
  var gb = (function () {
    ...
    Ca = (function () {
      ...
      return function (A, H, P) {
        ...
        "UTC:" === H.slice(0, 4) && ((H = H.slice(4)), (O = !0));
        P = O ? "getUTC" : "get";
        var Z = A[P + "Date"](),
          N = A[P + "Day"](),
          Y = A[P + "Month"](),
        ...
        return (P = H.replace(d, function (r) {
          switch (r) {
            case "D":
              return Z;
            case "DD":
            ...
            case "K":
              return O
                ? "UTC"
                : (String(A).match(t) || [""]).pop().replace(D, "");
            case "z":
    ...
    da = function (d, l, p) {
        ...
        if (((l = A[N]), "." === l && 0 > H)) H = N;
          ...
          if ("%" === l) D *= 100;
            ...
            ("E" !== l[0] && "e" !== l[0]) ||
              ...
              (O = !0);
          0 > H
            ? (P.push(l), "#" === l || "0" === l ? U++ : "," === l && I++)
            : (S.push(l), ("#" !== l && "0" !== l) || K++);
        }
      O &&
        ((l = Math.floor(d)),
        (A = -Math.floor(Math.log(d) / Math.LN10 + 1)),
        (Z = 0 === d ? 0 : 0 === l ? -(U + A) : nb(l).length - U),
        (D /= Math.pow(10, Z)));
      0 > H && (H = N);
      D = (d * D).toFixed(K);
      l = D.split(".");
      ...
      d = (l[1] + "").split("");
      D && "0" === D[0] && D.shift();
      for (O = A = N = K = H = 0; 0 < P.length; )
        if (((l = P.pop()), "#" === l || "0" === l))
          if ((H++, H === U)) {
            var Y = D,
              D = [];
            if ("0" === l)
              for (l = U - K - (Y ? Y.length : 0); 0 < l; ) Y.unshift("0"), l--;
            for (; 0 < Y.length; )
              (p = Y.pop() + p),
                O++,
                0 === O % A && N === I && 0 < Y.length && (p = t + p);
          } else
            0 < D.length
              ? ((p = D.pop() + p), K++, O++)
              : "0" === l && ((p = "0" + p), K++, O++),
              0 === O % A && N === I && 0 < D.length && (p = t + p);
        else
          ("E" !== l[0] && "e" !== l[0]) ||
          "0" !== l[l.length - 1] ||
          !/[eE][+-]*[0]+/.test(l)
            ? "," === l
              ? (N++, (A = O), (O = 0), 0 < D.length && (p = t + p))
              : (p =
                  1 < l.length &&
                  (('"' === l[0] && '"' === l[l.length - 1]) ||
                    ("'" === l[0] && "'" === l[l.length - 1]))
    ...
    Pa = function (d) {
      ...
      d.offsetX || 0 === d.offsetX
        ? ((l = d.offsetX), (p = d.offsetY))
        : d.layerX || 0 == d.layerX
        ? ((l = d.layerX), (p = d.layerY))
        : ((l = d.pageX - d.target.offsetLeft),
          (p = d.pageY - d.target.offsetTop));
      return { x: l, y: p };
    },
    bb = !0,
    ...
    Na = 1,
    ma = bb ? Ta / Na : 1,
    ea = function (d, l, p, v, t, A, D, H, U, P, S, O, K) {
      "undefined" === typeof K && (K = 1);
      D = D || 0;
      H = H || "black";
      var I = 15 < v - l && 15 < t - p ? 8 : 0.35 * Math.min(v - l, t - p);
      d.beginPath();
      d.moveTo(l, p);
      d.save();
      d.fillStyle = A;
      ...
      0 < D &&
        ...
        (d.strokeStyle = H),
        d.moveTo(l, p),
        d.rect(l - K, p - K, v - l + 2 * K, t - p + 2 * K),
        d.stroke());
      d.restore();
      !0 === U &&
        (d.save(),
        ...
        d.lineTo(v, p),
        d.closePath(),
        (D = d.createLinearGradient((v + l) / 2, p + I, (v + l) / 2, p)),
        D.addColorStop(0, A),
      ...
      !0 === P &&
        ...
        d.lineTo(v, t),
        d.closePath(),
        (D = d.createLinearGradient((v + l) / 2, t - I, (v + l) / 2, t)),
        D.addColorStop(0, A),
        D.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (d.fillStyle = D),
        d.fill(),
      ...
      !0 === S &&
        ...
        d.lineTo(l, t),
        d.closePath(),
        (D = d.createLinearGradient(l + I, (t + p) / 2, l, (t + p) / 2)),
        D.addColorStop(0, A),
      ...
      !0 === O &&
        ...
        d.lineTo(v - I, t - I),
        d.lineTo(v, t),
        (D = d.createLinearGradient(v - I, (t + p) / 2, v, (t + p) / 2)),
        D.addColorStop(0, A),
        D.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (d.fillStyle = D),
        D.addColorStop(0, A),
    ...
    if ("undefined" !== typeof d || this.options._isPlaceholder)
      if (
        ...
        var p = this.parent.options[this.optionsName],
          v = p.length;
        this.options._isPlaceholder || (Da(p), (v = p.indexOf(this.options)));
        ...
        (this.options = "undefined" === typeof d ? {} : d),
          ...
          this.optionsName
            ...
            ? ((v = p.charAt(0).toLowerCase()),
              1 < p.length && (v = v.concat(p.slice(1))),
              (p = v))
            : (p = void 0),
          (d[p] = this.options);
  };
  ...
  Z.prototype.updateOption = function (d) {
    ...
    var l = qa[this._defaultsKey],
      ...
      H = this._index;
    this.theme && p(this.parent) && p(A) && p(H)
      ? (v = p(this.predefinedThemes[this.theme])
          ? this.predefinedThemes.light1
          : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
          ...
          : this.parent.themeOptions[A] &&
            (null === H
              ...
              : 0 < this.parent.themeOptions[A].length &&
                ((v = Math.min(this.parent.themeOptions[A].length - 1, H)),
                (v = this.parent.themeOptions[A][v]))));
    this.themeOptions = v;
    d in l &&
      (t = d in this.options ? this.options[d] : v && d in v ? v[d] : l[d]);
  ...
  Z.prototype.addEventListener = function (d, p, v) {
    d &&
      p &&
      ((this._eventListeners[d] = this._eventListeners[d] || []),
      this._eventListeners[d].push({ context: v || this, eventHandler: p }));
  };
  ...
  Z.prototype.dispatchEvent = function (d, p, v) {
    if (d && this._eventListeners[d]) {
      p = p || {};
      for (var t = this._eventListeners[d], A = 0; A < t.length; A++)
        t[A].eventHandler.call(t[A].context, p);
    }
    "function" === typeof this[d] && this[d].call(v || this.chart, p);
  };
  Ea.prototype.registerSpace = function (d, p) {
    "top" === d
  ...
  Ea.prototype.unRegisterSpace = function (d, p) {
    "top" === d
      ? (this._topOccupied -= p.height)
      : "bottom" === d
      ? (this._bottomOccupied -= p.height)
    ...
    if (0 !== this.fontSize) {
      ...
      for (v = 0; v < this._wrappedText.lines.length; v++) {
        ...
        if ("right" === this.horizontalAlign || "right" === this.textAlign)
          t = this.width - H.width - this.rightPadding;
  ...
  ka.prototype._getLineWithWidth = function (d, p, v) {
    ...
    v > p &&
      1 < D.length &&
      ((D = D.substr(0, D.length - 1)), (v = this.ctx.measureText(D).width));
    p = !0;
    ...
    if (0 === this.frontSize) A = t = 0;
      ...
      for (; 0 < d.length; ) {
        ...
        var I = A,
          ...
          t = t + D.height,
          d = Ga(d.slice(D.text.length, d.length));
        H && t > H && ((D = p.pop()), (t -= D.height), (A = I));
      }
    this._wrappedText = { lines: p, width: A, height: t };
  ...
  Aa.prototype.setLayout = function () {
    if (this.text) {
      var d = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        l = d.layoutManager.getFreeSpace(),
        v = l.x1,
        t = l.y1,
        A = 0,
        H = 0,
      ...
      p(this.padding) || "number" !== typeof this.padding
        ? p(this.padding) ||
          ...
          (P += this.padding.bottom
            ...
            : 0))
        : (P = 2 * this.padding);
      this.wrap || (H = Math.min(H, 1.5 * this.fontSize + P));
      H = new ka(this.ctx, {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ? ((t = l.y1 + 2 + this.fontSize / 2 + 4), (K = "top"))
            : "bottom" === this.verticalAlign &&
              ((t = l.y2 - 2 - P.height + this.fontSize / 2 + 4),
              (K = "bottom")),
          "left" === this.horizontalAlign
            ? (v = l.x1 + 2)
            : "center" === this.horizontalAlign
            ? (v = l.x1 + l.width / 2 - P.width / 2)
            : "right" === this.horizontalAlign && (v = l.x2 - 2 - P.width - D),
          (I = this.horizontalAlign),
          (this.width = P.width),
          (this.height = P.height))
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((v = l.x1 + 2 + (this.fontSize / 2 + 4)),
              (t = l.y2 - 2 - (this.maxWidth / 2 - P.width / 2)),
              (A = -90),
              (K = "left"),
              (this.width = P.height),
              (this.height = P.width))
            : "right" === this.horizontalAlign
            ? ((v = l.x2 - 2 - (this.fontSize / 2 + 4)),
              (t = l.y1 + 2 + (this.maxWidth / 2 - P.width / 2)),
              (A = 90),
              (K = "right"),
              (this.width = P.height),
              (this.height = P.width))
      ...
      H.horizontalAlign = I;
      this._textBlock = H;
      d.layoutManager.registerSpace(K, {
        width:
          this.width + ("left" === K || "right" === K ? this.margin + 2 : 0),
        height:
          this.height + ("top" === K || "bottom" === K ? this.margin + 2 : 0),
      });
      this.bounds = { x1: v, y1: t, x2: v + this.width, y2: t + this.height };
  ...
  var Qa = {
    ...
    formatNumber: function (d, p, v) {
      v = v || "en";
      if (Ka[v]) return da(d, p || "#,##0.##", new Ja(v));
      throw "Unknown Culture Name";
    },
    formatDate: function (d, p, v) {
      v = v || "en";
      if (Ka[v]) return Ca(d, p || "DD MMM YYYY", new Ja(v));
      throw "Unknown Culture Name";
    },
  };
  ...
  t = Qa.Chart = (function () {
    ...
    function l(a, g, c) {
      ...
      this.theme =
        p(g.theme) || p(this.predefinedThemes[g.theme]) ? "light1" : g.theme;
      ...
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b =
            (Math.abs(
              (a[r].x - a[h].x) /
                (0 === a[r].x - a[x].x ? 0.01 : a[r].x - a[x].x)
            ) *
              (g - 1)) /
              2 +
            1;
          ...
          b = (a[r].y - a[h].y) / b;
          c[c.length] =
            (a[x].x > a[h].x && 0 < J) || (a[x].x < a[h].x && 0 > J)
              ? { x: a[x].x + J / 3, y: a[x].y + b / 3 }
              : { x: a[x].x, y: a[x].y + (1 === c.length ? 0 : b / 9) };
          x = e;
          h = 0 === x ? 0 : x - 1;
          r = x === a.length - 1 ? x : x + 1;
          b =
            (Math.abs(
              (a[r].x - a[h].x) /
                (0 === a[x].x - a[h].x ? 0.01 : a[x].x - a[h].x)
            ) *
              (g - 1)) /
              2 +
            1;
    ...
    function A(a, g, c, b, e, h, r, x, J, k) {
      ...
      var m = 1 === Math.round(r.thickness) % 2 ? 0.5 : 0,
        q = 1 === Math.round(x.thickness) % 2 ? 0.5 : 0;
      a.save();
      a.globalAlpha = k;
      ...
      a.beginPath();
      J && 0 < x.thickness
        ? (a.moveTo(b - r.thickness / 2, Math.round((c + e) / 2) - q),
          a.lineTo(g + r.thickness / 2, Math.round((c + e) / 2) - q))
        : 0 < x.thickness &&
          (a.moveTo(Math.round((g + b) / 2) - q, c + r.thickness / 2),
          a.lineTo(Math.round((g + b) / 2) - q, e - r.thickness / 2));
      a.stroke();
    ...
    function X(a, g, c, b) {
      X.base.constructor.call(this, "DataSeries", "data", g, c, a);
      this.chart = a;
      this.canvas = a.canvas;
    ...
    function ia(a, g, c, b) {
      ia.base.constructor.call(this, "ScaleBreaks", "scaleBreaks", g, null, b);
      this.id = c;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.axis = b;
    ...
    function ga(a, g, c, b, e, h) {
      ga.base.constructor.call(this, "Break", g, c, b, h);
      this.id = e;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.scaleBreaks = h;
    ...
    function ca(a, g, c) {
      ca.base.constructor.call(this, "Crosshair", "crosshair", g, null, c);
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.axis = c;
    ...
    function V(a, g) {
      V.base.constructor.call(this, "ToolTip", "toolTip", g, null, a);
      this.chart = a;
      this.canvas = a.canvas;
      this.ctx = this.chart.ctx;
    ...
    l.prototype.setLayout = function () {
      ...
      if (
        ...
        for (g = 0; g < this._axes.length; g++)
          if (
            !p(this._axes[g].viewportMinimum) ||
            !p(this._axes[g].viewportMaximum)
          ) {
            c = !0;
            break;
          }
    ...
    l.prototype.renderElements = function () {
      if (this.height) {
        ...
        for (g = 0; g < this.plotInfo.plotTypes.length; g++)
          for (
            var h = this.plotInfo.plotTypes[g], r = 0;
            ...
            x.targetCanvas = null;
            this.animatedRender &&
              ((x.targetCanvas = va(this.width, this.height)),
              (x.targetCanvasCtx = x.targetCanvas.getContext("2d")),
              (e = x.targetCanvasCtx.miterLimit),
              (x.targetCanvasCtx.miterLimit = 3));
            "line" === x.type
              ? (J = this.renderLine(x))
              : "stepLine" === x.type
              ? (J = this.renderStepLine(x))
              : "spline" === x.type
              ? (J = this.renderSpline(x))
              : "column" === x.type
              ? (J = this.renderColumn(x))
              : "bar" === x.type
              ? (J = this.renderBar(x))
              : "area" === x.type
              ? (J = this.renderArea(x))
              : "stepArea" === x.type
              ? (J = this.renderStepArea(x))
              : "splineArea" === x.type
              ? (J = this.renderSplineArea(x))
              : "stackedColumn" === x.type
              ? (J = this.renderStackedColumn(x))
              : "stackedColumn100" === x.type
              ? (J = this.renderStackedColumn100(x))
              : "stackedBar" === x.type
              ? (J = this.renderStackedBar(x))
              : "stackedBar100" === x.type
              ? (J = this.renderStackedBar100(x))
              : "stackedArea" === x.type
              ? (J = this.renderStackedArea(x))
              : "stackedArea100" === x.type
              ? (J = this.renderStackedArea100(x))
              : "bubble" === x.type
              ? (J = J = this.renderBubble(x))
              : "scatter" === x.type
              ? (J = this.renderScatter(x))
              : "pie" === x.type
              ? this.renderPie(x)
              : "doughnut" === x.type
              ? this.renderPie(x)
              : "funnel" === x.type
              ? (J = this.renderFunnel(x))
              : "pyramid" === x.type
              ? (J = this.renderFunnel(x))
              : "candlestick" === x.type
              ? (J = this.renderCandlestick(x))
              : "ohlc" === x.type
              ? (J = this.renderCandlestick(x))
              : "rangeColumn" === x.type
              ? (J = this.renderRangeColumn(x))
              : "error" === x.type
              ? (J = this.renderError(x))
              : "rangeBar" === x.type
              ? (J = this.renderRangeBar(x))
              : "rangeArea" === x.type
              ? (J = this.renderRangeArea(x))
              : "rangeSplineArea" === x.type
              ? (J = this.renderRangeSplineArea(x))
              : "waterfall" === x.type
              ? (J = this.renderWaterfall(x))
              : "boxAndWhisker" === x.type && (J = this.renderBoxAndWhisker(x));
            for (var k = 0; k < x.dataSeriesIndexes.length; k++)
              this._dataInRenderedOrder.push(this.data[x.dataSeriesIndexes[k]]);
            this.animatedRender &&
              ((x.targetCanvasCtx.miterLimit = e), J && c.push(J));
          }
            ...
            m._animator.animate(
              ...
              function () {
                ...
                for (var a = 0; a < m.plotInfo.plotTypes.length; a++)
                  for (
                    var e = m.plotInfo.plotTypes[a], f = 0;
    ...
    l.prototype.categoriseDataSeries = function () {
      ...
      for (g = 0; g < this.plotInfo.plotTypes.length; g++)
        for (
          c = this.plotInfo.plotTypes[g], r = a = 0;
    ...
    l.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = !1, r = 0;
          ...
          if ("normal" === x.axisPlacement || "xySwapped" === x.axisPlacement)
            var n = a.axisX.sessionVariables.newViewportMinimum
              ...
              f = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (x.dataPoints[J].x && x.dataPoints[J].x.getTime) ||
            "dateTime" === x.xValueType
          )
            h = !0;
          for (J = 0; J < x.dataPoints.length; J++) {
            "undefined" === typeof x.dataPoints[J].x &&
              (x.dataPoints[J].x = J + (a.axisX.logarithmic ? 1 : 0));
            x.dataPoints[J].x.getTime
              ? ((h = !0), (b = x.dataPoints[J].x.getTime()))
              : (b = x.dataPoints[J].x);
            e = x.dataPoints[J].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < J) {
              if (a.axisX.logarithmic) {
                ...
                (d = b - x.dataPoints[J - 1].x),
                  0 > d && (d *= -1),
                  c.minDiff > d && 0 !== d && (c.minDiff = d);
              null !== e &&
                null !== x.dataPoints[J - 1].y &&
                (a.axisY.logarithmic
                  ? ((d = e / x.dataPoints[J - 1].y),
                    1 > d && (d = 1 / d),
            ...
            if (b < n && !k) null !== e && (q = b);
              ...
              x.dataPoints[J].label &&
                (a.axisX.labels[b] = x.dataPoints[J].label);
    ...
    l.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          var n = this.data[a.dataSeriesIndexes[q]],
            f = 0,
            d = !1,
            w = !1,
            y;
          if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement)
            var s = a.axisX.sessionVariables.newViewportMinimum
              ...
              z = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (n.dataPoints[f].x && n.dataPoints[f].x.getTime) ||
            "dateTime" === n.xValueType
          )
            h = !0;
          for (f = 0; f < n.dataPoints.length; f++) {
            "undefined" === typeof n.dataPoints[f].x &&
              (n.dataPoints[f].x = f + (a.axisX.logarithmic ? 1 : 0));
            n.dataPoints[f].x.getTime
              ? ((h = !0), (b = n.dataPoints[f].x.getTime()))
              : (b = n.dataPoints[f].x);
            ...
            if (0 < f) {
              if (a.axisX.logarithmic) {
                ...
                (u = b - n.dataPoints[f - 1].x),
                  0 > u && (u *= -1),
                  c.minDiff > u && 0 !== u && (c.minDiff = u);
              null !== e &&
                null !== n.dataPoints[f - 1].y &&
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((u = e / n.dataPoints[f - 1].y),
                    1 > u && (u = 1 / u),
            ...
            if (b < s && !d) null !== n.dataPoints[f].y && (y = b);
            else {
              if (!d && ((d = !0), 0 < f)) {
                f -= 2;
                continue;
              ...
              n.dataPoints[f].label &&
                (a.axisX.labels[b] = n.dataPoints[f].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === n.dataPoints[f].y
                ? c.viewPortMin === b && y < b && (c.viewPortMin = y)
                : ((m[b] = (m[b] || 0) + n.dataPoints[f].y),
                  (n.dataPointEOs[f].cumulativeY = m[b]),
                  ...
                  0 <= e
                    ? r[b]
                      ? (r[b] += e)
                      : ((r[b] = e), (J = Math.min(e, J)))
                    : x[b]
                    ? (x[b] += e)
                    : ((x[b] = e), (k = Math.max(e, k))));
            }
          }
          a.axisY.scaleBreaks &&
            ...
            (g.dataPointYPositiveSums
              ...
              : ((g.dataPointYPositiveSums = r),
                (g.dataPointYNegativeSums = x)));
        ...
        for (f in r)
          r.hasOwnProperty(f) &&
            !isNaN(f) &&
            ((a = r[f]),
            a < g.min && (g.min = Math.min(a, J)),
            a > g.max && (g.max = a),
            f < c.viewPortMin ||
              f > c.viewPortMax ||
              (a < g.viewPortMin && (g.viewPortMin = Math.min(a, J)),
    ...
    l.prototype._processStacked100PlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          var q = this.data[a.dataSeriesIndexes[m]],
            n = 0,
            f = !1,
            d = !1,
            w;
          ...
          for (n = 0; n < q.dataPoints.length; n++) {
            ...
            q.dataPoints[n].x.getTime
              ? ((h = !0), (b = q.dataPoints[n].x.getTime()))
              : (b = q.dataPoints[n].x);
            ...
            if (b < y && !f) null !== e && (w = b);
              ...
              q.dataPoints[n].label &&
                (a.axisX.labels[b] = q.dataPoints[n].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === e
                ? c.viewPortMin === b && w < b && (c.viewPortMin = w)
                : ((J[b] = (J[b] || 0) + q.dataPoints[n].y),
                  (q.dataPointEOs[n].cumulativeY = J[b]),
                  (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                  (a.yAbsTotals[b] =
                    (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e)),
                  0 <= e ? (r = !0) : 0 > e && (x = !0),
        ...
        a.axisY.logarithmic
          ? ((g.max = p(g.viewPortMax)
              ? 99 * Math.pow(a.axisY.logarithmBase, -0.05)
              : Math.max(
                  g.viewPortMax,
                  99 * Math.pow(a.axisY.logarithmBase, -0.05)
                )),
            (g.min = p(g.viewPortMin) ? 1 : Math.min(g.viewPortMin, 1)))
          : r && !x
          ? ((g.max = p(g.viewPortMax) ? 99 : Math.max(g.viewPortMax, 99)),
            (g.min = p(g.viewPortMin) ? 1 : Math.min(g.viewPortMin, 1)))
          : r && x
          ? ((g.max = p(g.viewPortMax) ? 99 : Math.max(g.viewPortMax, 99)),
          ...
          : !r &&
            x &&
            ((g.max = p(g.viewPortMax) ? -1 : Math.max(g.viewPortMax, -1)),
            (g.min = p(g.viewPortMin) ? -99 : Math.min(g.viewPortMin, -99)));
        g.viewPortMin = g.min;
        g.viewPortMax = g.max;
        a.dataPointYSums = k;
        ...
        for (
          ...
          for (m = 0; m < k.dataPoints.length; m++) {
            ...
            k.dataPoints[m].x.getTime
              ? ((x = !0), (b = k.dataPoints[m].x.getTime()))
              : (b = k.dataPoints[m].x);
            ...
            if (!(b < y) || q) {
              ...
              null === e
                ...
                : (h < g.viewPortMin && (g.viewPortMin = h),
                  r > g.viewPortMax && (g.viewPortMax = r));
            }
          }
          ...
          if ("normal" === x.axisPlacement || "xySwapped" === x.axisPlacement)
            var n = a.axisX.sessionVariables.newViewportMinimum
              ...
              f = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (x.dataPoints[d].x && x.dataPoints[d].x.getTime) ||
            "dateTime" === x.xValueType
          )
            h = !0;
          for (d = 0; d < x.dataPoints.length; d++)
            "undefined" !== typeof x.dataPoints[d].isCumulativeSum &&
            !0 === x.dataPoints[d].isCumulativeSum
              ? ((x.dataPointEOs[d].cumulativeSumYStartValue = 0),
                (x.dataPointEOs[d].cumulativeSum =
                  0 === d ? 0 : x.dataPointEOs[d - 1].cumulativeSum),
                (x.dataPoints[d].y =
                  0 === d ? 0 : x.dataPointEOs[d - 1].cumulativeSum))
              : "undefined" !== typeof x.dataPoints[d].isIntermediateSum &&
                !0 === x.dataPoints[d].isIntermediateSum
              ? ((x.dataPointEOs[d].cumulativeSumYStartValue = q),
                (x.dataPointEOs[d].cumulativeSum =
                  0 === d ? 0 : x.dataPointEOs[d - 1].cumulativeSum),
                (x.dataPoints[d].y = 0 === d ? 0 : b),
                (q = 0 === d ? 0 : x.dataPointEOs[d - 1].cumulativeSum),
                (b = 0))
              : ((e =
                  "number" !== typeof x.dataPoints[d].y
                    ? 0
                    : x.dataPoints[d].y),
                (x.dataPointEOs[d].cumulativeSumYStartValue =
                  0 === d ? 0 : x.dataPointEOs[d - 1].cumulativeSum),
                (x.dataPointEOs[d].cumulativeSum =
                  0 === d ? e : x.dataPointEOs[d - 1].cumulativeSum + e),
                (b += e));
          for (d = 0; d < x.dataPoints.length; d++)
            if (
              ("undefined" === typeof x.dataPoints[d].x &&
                (x.dataPoints[d].x = d + (a.axisX.logarithmic ? 1 : 0)),
              x.dataPoints[d].x.getTime
                ? ((h = !0), (b = x.dataPoints[d].x.getTime()))
                : (b = x.dataPoints[d].x),
              (e = x.dataPoints[d].y),
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              x.dataPointEOs[d].cumulativeSum < g.min &&
                (g.min = x.dataPointEOs[d].cumulativeSum),
              x.dataPointEOs[d].cumulativeSum > g.max &&
                (g.max = x.dataPointEOs[d].cumulativeSum),
              0 < d &&
                (a.axisX.logarithmic
                  ? ((q = b / x.dataPoints[d - 1].x),
                    1 > q && (q = 1 / q),
                ...
                null !== e &&
                  null !== x.dataPoints[d - 1].y &&
                  (a.axisY.logarithmic
                    ? ((e =
                        x.dataPointEOs[d].cumulativeSum /
                        x.dataPointEOs[d - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              x.dataPoints[d].label &&
                (a.axisX.labels[b] = x.dataPoints[d].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < d &&
                (x.dataPointEOs[d - 1].cumulativeSum < g.viewPortMin &&
                  (g.viewPortMin = x.dataPointEOs[d - 1].cumulativeSum),
                x.dataPointEOs[d - 1].cumulativeSum > g.viewPortMax &&
                  (g.viewPortMax = x.dataPointEOs[d - 1].cumulativeSum));
              x.dataPointEOs[d].cumulativeSum < g.viewPortMin &&
                (g.viewPortMin = x.dataPointEOs[d].cumulativeSum);
              x.dataPointEOs[d].cumulativeSum > g.viewPortMax &&
                (g.viewPortMax = x.dataPointEOs[d].cumulativeSum);
            }
          x.axisX.valueType = x.xValueType = h ? "dateTime" : "number";
        }
    };
    l.prototype.calculateAutoBreaks = function () {
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if (b || c)
            for (
              ...
              var J = e.data[a.dataSeriesIndexes[d]];
              if (!(4 > J.dataPoints.length))
                for (x = 0; x < J.dataPoints.length; x++)
                  if (
                    (b &&
                      ((n =
                        ((k + 1 - r) *
                        ...
                        100),
                      (h = J.dataPoints[x].x.getTime
                        ? J.dataPoints[x].x.getTime()
                        : J.dataPoints[x].x),
                      (n = Math.floor((h - r) / n)),
                      h < g[n].min && (g[n].min = h),
                      h > g[n].max && (g[n].max = h)),
                    ...
                    if (
                      (h =
                        "waterfall" === a.type
                          ? J.dataPointEOs[x].cumulativeSum
                          : J.dataPoints[x].y) &&
                      h.length
                    )
                      for (var l = 0; l < h.length; l++)
                        (n = Math.floor((h[l] - m) / v)),
                          h[l] < f[n].min && (f[n].min = h[l]),
                          h[l] > f[n].max && (f[n].max = h[l]);
                    else
                      p(h) ||
                        ((n = Math.floor((h - m) / v)),
                        h < f[n].min && (f[n].min = h),
      ...
      for (var b, e = this, h = !1, r = 0; r < this._axes.length; r++)
        if (
      ...
      if (h) {
        for (r = 0; r < this.plotInfo.plotTypes.length; r++)
          for (
            h = this.plotInfo.plotTypes[r], x = 0;
            x < h.plotUnits.length;
            x++
          )
            (b = h.plotUnits[x]),
              "line" === b.type ||
          ...
          if (this._axes[r].dataInfo._dataRanges) {
            ...
            for (x = 0; x < k.length - 1; x++)
              if (((m = k[x].max), isFinite(m)))
                for (; x < k.length - 1; )
                  if (((d = k[x + 1].min), isFinite(d))) {
                    q = d - m;
                    q > b && h.push({ diff: q, start: m, end: d });
                    break;
                  } else x++;
            if (this._axes[r].scaleBreaks.customBreaks)
              for (
                x = 0;
                x < this._axes[r].scaleBreaks.customBreaks.length;
                x++
              )
                for (b = 0; b < h.length; b++)
                  if (
                    (this._axes[r].scaleBreaks.customBreaks[x].startValue <=
                      h[b].start &&
                      h[b].start <=
                        this._axes[r].scaleBreaks.customBreaks[x].endValue) ||
                    (this._axes[r].scaleBreaks.customBreaks[x].startValue <=
                      h[b].start &&
                      h[b].start <=
                        this._axes[r].scaleBreaks.customBreaks[x].endValue) ||
    ...
    l.prototype._touchEventHandler = function (a) {
      if (a.changedTouches && this.interactivityEnabled) {
        ...
        if (!(c && 1 < c.length)) {
          ...
          e.time = new Date();
          try {
            var r = e.y - this._lastTouchData.y,
        ...
        if (
          ...
          for (var x = 0; x < this.axisX.length; x++)
            this.axisX[x].crosshair &&
              this.axisX[x].crosshair.enabled &&
              (this.axisX[x].crosshair.hide(),
              this.axisX[x].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisX[x].options },
                this.axisX[x].crosshair
              ));
          for (x = 0; x < this.axisX2.length; x++)
            this.axisX2[x].crosshair &&
              this.axisX2[x].crosshair.enabled &&
              (this.axisX2[x].crosshair.hide(),
              this.axisX2[x].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisX2[x].options },
                this.axisX2[x].crosshair
              ));
          for (x = 0; x < this.axisY.length; x++)
            this.axisY[x].crosshair &&
              this.axisY[x].crosshair.enabled &&
              (this.axisY[x].crosshair.hide(),
              this.axisY[x].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisY[x].options },
                this.axisY[x].crosshair
              ));
          for (x = 0; x < this.axisY2.length; x++)
            this.axisY2[x].crosshair &&
              this.axisY2[x].crosshair.enabled &&
              (this.axisY2[x].crosshair.hide(),
              this.axisY2[x].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisY2[x].options },
                this.axisY2[x].crosshair
              ));
        } else
          this.panEnabled ||
          ...
          if (this.panEnabled)
            (e = {
              ...
              (r._panTimerId = setTimeout(
                (function (b, c, e, f) {
                  return function () {
                    r._zoomPanToSelectedRegion(b, c, e, f, !0) &&
            ...
            var b = e ? this.dragStartPoint.x : this.plotArea.x1,
              x = h ? this.dragStartPoint.y : this.plotArea.y1,
              d = e
    ...
    l.prototype.validateRegion = function (a, g, c, b, e) {
      ...
      for (
        ...
        (("axisX" === this._axes[q].type && h) ||
          ("axisY" === this._axes[q].type && r)) &&
          k.push(this._axes[q]);
      for (r = 0; r < k.length; r++) {
        var q = k[r],
          h = !1,
          n = q.convertPixelToValue({ x: a, y: g }),
          f = q.convertPixelToValue({ x: c, y: b });
        if (n > f)
          var p = f,
            f = n,
            n = p;
        if (q.scaleBreaks)
          for (p = 0; !h && p < q.scaleBreaks._appliedBreaks.length; p++)
            h =
              q.scaleBreaks._appliedBreaks[p].startValue <= n &&
              q.scaleBreaks._appliedBreaks[p].endValue >= f;
        if (isFinite(q.dataInfo.minDiff))
          if (
            ((p = q.getApparentDifference(n, f, null, !0)),
            !(
              h ||
              (!(
                this.panEnabled &&
                ...
                ((q.logarithmic && p < Math.pow(q.dataInfo.minDiff, 3)) ||
                  (!q.logarithmic && p < 3 * Math.abs(q.dataInfo.minDiff)))) ||
              n < q.minimum ||
              f > q.maximum
            ))
          )
            d.push(q), m.push({ val1: n, val2: f }), (x = !0);
          else if (!e) {
            x = !1;
            break;
          }
    ...
    l.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var m = this._indexLabels[a],
          q = m.chartType.toLowerCase(),
          n,
          f,
          x = na("indexLabelFontColor", m.dataPoint, m.dataSeries),
          Ra = na("indexLabelFontSize", m.dataPoint, m.dataSeries),
        ...
        var h = na("indexLabelWrap", m.dataPoint, m.dataSeries),
          y = na("indexLabelLineDashType", m.dataPoint, m.dataSeries),
        ...
        if (null !== C && "" !== C) {
          var u = na("indexLabelPlacement", m.dataPoint, m.dataSeries),
            ...
            B = na("indexLabelTextAlign", m.dataPoint, m.dataSeries),
            t = m.direction,
            e = m.dataSeries.axisX,
            r = m.dataSeries.axisY,
            A = !1,
            w = new ka(g, {
              x: 0,
              y: 0,
          ...
          if ("stackedarea100" === q) {
            ...
            if (
              ...
              Math.max.apply(null, m.dataPoint.y) < r.viewportMinimum ||
              Math.min.apply(null, m.dataPoint.y) > r.viewportMaximum
            )
              continue;
          } else if (
            0 <= q.indexOf("line") ||
            ...
            if (
              m.dataPoint.x < e.viewportMinimum ||
              m.dataPoint.x > e.viewportMaximum ||
              m.dataPoint.y < r.viewportMinimum ||
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            if (0 <= q.indexOf("line") || 0 <= q.indexOf("area"))
              (u = "auto"), (x = 4);
            else if (0 <= q.indexOf("stacked")) "auto" === u && (u = "inside");
            else if ("bubble" === q || "scatter" === q) u = "inside";
            n =
            ...
            if ("inside" !== u)
              (e = c.y1),
                (h = c.y2),
                0 < t
                  ? ((f = m.point.y + w._lineHeight / 2 - k - x - b),
                    f < e &&
                      ((f =
                        "auto" === u
                          ? Math.max(m.point.y, e) + w._lineHeight / 2 + x + b
                          : e + w._lineHeight / 2 + x + b),
                      (A =
                        f + ("horizontal" === l ? k - w._lineHeight / 2 : 0) >
                        m.point.y),
                      !A ||
                        0 <= q.indexOf("line") ||
                        0 <= q.indexOf("area") ||
                        (f -= b)))
                  : ((f = m.point.y + w._lineHeight / 2 + x + b),
                    f > h - k + w._lineHeight / 2 - x &&
                      ((f =
                        "auto" === u
                          ? Math.min(m.point.y, h) +
                            ...
                            x -
                            b
                          : h + w._lineHeight / 2 - k - x - b),
                      (A =
                        f - ("horizontal" === l ? w._lineHeight / 2 : k) <
                        m.point.y),
                      !A ||
                        0 <= q.indexOf("line") ||
                        0 <= q.indexOf("area") ||
              ...
              b =
                0 <= q.indexOf("range") || "error" === q
                  ? 0 < t
                    ? Math.max(m.bounds.y1, c.y1) + w._lineHeight / 2 + x
                    : Math.min(m.bounds.y2, c.y2) + w._lineHeight / 2 - k - x
                  : (Math.max(m.bounds.y1, c.y1) +
              ...
              if (0 < t) {
                if (((f = b), "bubble" === q || "scatter" === q))
                  (f = m.point.y - k / 2 + w._lineHeight / 2),
                    k > m.bounds.y2 - m.bounds.y1 && (f -= k / 2 + x),
                    0 > f - w._lineHeight / 2 &&
                      (f +=
                        Math.abs(f - w._lineHeight / 2) <=
                        (m.bounds.y2 - m.bounds.y1) / 2 + x
                          ? Math.abs(f - w._lineHeight / 2)
                          : (m.bounds.y2 - m.bounds.y1) / 2 + x);
              } else
                (f = Math.min(m.point.y, b)),
                  f > h - k - x &&
                    ("bubble" === q || "scatter" === q) &&
                    (f = Math.min(m.point.y + x, c.y2 - k - x));
              f = Math.min(f, h);
            }
          } else
            0 <= q.indexOf("line") ||
            ...
            0 <= q.indexOf("scatter")
              ...
              ? "auto" === u && (u = "inside")
              : "bubble" === q && (u = "inside"),
              (f = m.point.y + w._lineHeight / 2 - k / 2),
              "inside" !== u
                ? ((h = c.x1),
                  (e = c.x2),
                  0 > t
                    ? ((n =
                        ...
                        r -
                        b),
                      ("horizontal" === l ? n : n - w._lineHeight / 2) < h &&
                        ((n =
                          "auto" === u
                            ...
                            : h +
                              ...
                              r),
                        (A =
                          n + d - ("horizontal" === l ? 0 : w._lineHeight / 2) >
                          m.point.x) && (n -= b)))
                    : ((n =
                        m.point.x +
                        ("horizontal" === l ? 0 : w._lineHeight / 2) +
                        r +
                        b),
                      ("horizontal" === l ? n : n - w._lineHeight / 2) >
                        e - d - r - b &&
                        ((n =
                          "auto" === u
                            ? Math.min(m.point.x, e) -
                            ...
                            : e -
                              ...
                              ("horizontal" === l ? 0 : w._lineHeight / 2)),
                        (A =
                          n - ("horizontal" === l ? 0 : w._lineHeight / 2) <
                          m.point.x) && (n += b))))
                  ...
                  (b =
                    0 <= q.indexOf("range") || "error" === q
                      ...
                      : (Math.max(m.bounds.x1, c.x1) +
                        ...
                        d / 2 +
                        ("horizontal" === l ? 0 : w._lineHeight / 2)),
                  (n = 0 > t ? b : Math.min(m.point.x, b)),
                  (n = Math.max(
                    n,
                    h + ("horizontal" === l ? 0 : w._lineHeight / 2 + x)
                  )));
          "vertical" === l &&
            ((f += k - w._lineHeight / 2),
            0 <=
          ...
          z &&
            ...
            g.setLineDash && g.setLineDash(H(y, z)),
            g.beginPath(),
            g.moveTo(m.point.x, m.point.y),
            0 <= q.indexOf("bar") || ("error" === q && m.axisSwapped)
              ? g.lineTo(
                  n +
                    (0 < m.direction ? 0 : d) +
                    ("vertical" === l ? -w._lineHeight / 2 : 0),
                  f + ("vertical" === l ? -k / 2 : k / 2 - w._lineHeight / 2)
                )
              : 0 <= q.indexOf("column") || ("error" === q && !m.axisSwapped)
              ? g.lineTo(
                  n + d / 2 - ("horizontal" === l ? 0 : w._lineHeight / 2),
                  f +
                    ("vertical" === l
                      ? f - k < m.point.y
                        ? 0
                        : -k
                      : (f - w._lineHeight / 2 < m.point.y ? k : 0) -
                        w._lineHeight / 2)
                )
              : 0 <= q.indexOf("waterfall")
              ? g.lineTo(
                  n + d / 2 - ("horizontal" === l ? 0 : w._lineHeight / 2),
                  "vertical" === l
                    ? 0 < t && f < m.point.y
                      ...
                      ? f - k
                      : m.point.y
                    : 0 < t && f + k - w._lineHeight / 2 < m.point.y
                    ? f + k - w._lineHeight / 2
                    : 0 > t && f - w._lineHeight / 2 > m.point.y
                    ? f - w._lineHeight / 2
                    : m.point.y
                )
              : g.lineTo(
                  ...
                  f +
                    ("vertical" === l
                      ? f - k < m.point.y
                        ? 0
                        : -k
                      : (f + k - w._lineHeight / 2 < m.point.y ? k : 0) -
                        w._lineHeight / 2)
                ),
            g.stroke());
        }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var h = [], r, x = 0; x < a.dataSeriesIndexes.length; x++) {
          ...
          var m = k.dataPoints,
            q = "solid";
          if (c.setLineDash) {
            var n = H(k.nullDataLineDashType, k.lineThickness),
              q = k.lineDashType,
              f = H(q, k.lineThickness);
            c.setLineDash(f);
          }
          var p = k.id;
                  ...
                  y || E
                    ...
                    : (c.lineTo(l, u),
                      ...
                      0 == s % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(l, u),
                        v && (b.stroke(), b.beginPath(), b.moveTo(l, u))));
                  r = { x: l, y: u };
                  s < m.length - 1 &&
                    (w !== (m[s].lineColor || p) ||
                      q !== (m[s].lineDashType || k.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(l, u),
                    (w = m[s].lineColor || p),
                    ...
                    c.setLineDash &&
                      (m[s].lineDashType
                        ? ((q = m[s].lineDashType),
                          c.setLineDash(H(q, k.lineThickness)))
                        : ((q = k.lineDashType), c.setLineDash(f))));
                  if (
                    0 !== m[s].markerSize &&
                    (0 < m[s].markerSize || 0 < k.markerSize)
                  ) {
                    var B = k.getMarkerProperties(s, l, u, c);
                    h.push(B);
                    C = U(C);
                    v &&
                      h.push({
            ...
            for (z = !1, l = 0; l < m.length; l++)
              if (
                ...
                if ("number" !== typeof m[l].y)
                  0 < l &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !m[l - 1].lineDashType) &&
                        ((u[u.length - 1].newLineDashArray = n),
                        (q = k.nullDataLineDashType))
                      : (g(u), (u = []))),
                    (z = !0);
                else {
                  ...
                  l < m.length - 1 &&
                    (w !== (m[l].lineColor || p) ||
                      q !== (m[l].lineDashType || k.lineDashType)) &&
                    ((w = m[l].lineColor || p),
                    (u[u.length - 1].newStrokeStyle = w),
                    b.setLineDash &&
                      (m[l].lineDashType
                        ? ((q = m[l].lineDashType),
                          (u[u.length - 1].newLineDashArray = H(
                            q,
                            k.lineThickness
                          )))
                        : ((q = k.lineDashType),
    ...
    l.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < p.length)
            for (
              var l = 5 < q && f.bevelEnabled ? !0 : !1, h = 0;
              h < p.length;
              h++
            )
              if (
                ...
                r = a.axisX.reversed
                  ? (r +
                      ...
                      (a.previousDataSeriesCount + m) * q) <<
                    0
                  : (r -
                      (a.plotType.totalDataSeries * q) / 2 +
                      (a.previousDataSeriesCount + m) * q) <<
                    0;
                var y = a.axisX.reversed ? (r - q) << 0 : (r + q) << 0,
                  s;
                0 <= p[h].y ? (s = k) : ((s = x), (x = k));
                x > s && ((b = x), (x = s), (s = b));
                b = p[h].color
                ...
                ea(
                  ...
                  0,
                  null,
                  l && (a.axisY.reversed ? 0 > p[h].y : 0 <= p[h].y),
                  (a.axisY.reversed ? 0 <= p[h].y : 0 > p[h].y) && l,
                  !1,
                  !1,
                  f.fillOpacity
                );
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                if (
                  ...
                  (d[b] = s[k].y + (d[b] ? d[b] : 0)),
                    (E = a.axisY.convertValueToPixel(d[b])),
                    (q = "undefined" !== typeof r[b] ? r[b] : n),
                    (r[b] = E);
                else if (
                  ((q = a.axisY.convertValueToPixel(s[k].y)), 0 <= s[k].y)
                ) {
                ...
                ea(
                  c,
                  m,
                  a.axisY.reversed ? E : q,
                  u,
                  a.axisY.reversed ? q : E,
                  b,
                  0,
                  null,
    ...
    l.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (f = 0; f < a.dataSeriesIndexes.length; f++) {
          ...
          if (0 < s.length)
            for (
              var z = 5 < p && y.bevelEnabled ? !0 : !1, k = 0;
              k < s.length;
              k++
            )
              if (
                ...
                if (
                  ...
                  (d[b] = q + ("undefined" !== typeof d[b] ? d[b] : 0)),
                    (E = a.axisY.convertValueToPixel(d[b])),
                    (q = r[b] ? r[b] : n),
                    (r[b] = E);
              ...
              if (
                ...
                x = a.axisX.reversed
                  ...
                  : (x -
                      ...
                      (a.previousDataSeriesCount + m) * q) <<
                    0;
                var y = a.axisX.reversed ? (x - q) << 0 : (x + q) << 0,
                  s;
                0 <= p[h].y ? (s = k) : ((s = r), (r = k));
                b = p[h].color
                  ? p[h].color
          ...
          if (0 < s.length) {
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                q =
                  (q - (a.plotType.plotUnits.length * l) / 2 + a.index * l) <<
                  0;
                var u = (q + l) << 0,
                  E;
                if (
                  ...
                  (p[b] = s[k].y + (p[b] ? p[b] : 0)),
                    (m = r[b] ? r[b] : n),
                    (r[b] = E = a.axisY.convertValueToPixel(p[b]));
                else if (
    ...
    l.prototype.renderArea = function (a) {
      ...
      function b() {
        C &&
          ...
          h.fill(),
          (h.globalAlpha = 1),
          v && (r.lineTo(y, E), r.lineTo(C.x, E), r.closePath(), r.fill()),
          h.beginPath(),
          h.moveTo(y, s),
          r.beginPath(),
          r.moveTo(y, s),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          var w = 0,
            ...
            C = null;
          if (0 < l.length) {
            var B = f._colorSet[w % f._colorSet.length],
              t = (f.lineColor = f.options.lineColor || B),
              A = t;
            h.fillStyle = B;
            h.strokeStyle = t;
            ...
            for (var fa = !0; w < l.length; w++)
              if (
                ...
                if ("number" !== typeof l[w].y)
                  ...
                  w < l.length - 1 &&
                    (A !== (l[w].lineColor || t) ||
                      c !== (l[w].lineDashType || f.lineDashType)) &&
                    (b(),
                    (A = l[w].lineColor || t),
                    (h.strokeStyle = A),
                    h.setLineDash &&
                      (l[w].lineDashType
                        ? ((c = l[w].lineDashType),
                          h.setLineDash(H(c, f.lineThickness)))
                        : ((c = f.lineDashType), h.setLineDash(Q))));
                  ...
                  0 !== l[w].markerSize &&
                    (0 < l[w].markerSize || 0 < f.markerSize) &&
                    ((z = f.getMarkerProperties(w, y, s, h)),
                    p.push(z),
                    (aa = U(aa)),
                    v &&
                      p.push({
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < q.length) {
            var u = m._colorSet[n % m._colorSet.length],
              E = (m.lineColor = m.options.lineColor || u),
              C = E;
            b.fillStyle = u;
            b.strokeStyle = E;
            ...
            var B = "solid";
            if (b.setLineDash) {
              var A = H(m.nullDataLineDashType, m.lineThickness),
                B = m.lineDashType,
                D = H(B, m.lineThickness);
              b.setLineDash(D);
            }
            for (l = !1; n < q.length; n++)
              if (
                ((f = q[n].x.getTime ? q[n].x.getTime() : q[n].x),
                !(
                ...
                if ("number" !== typeof q[n].y)
                  ...
                  n < q.length - 1 &&
                    (C !== (q[n].lineColor || E) ||
                      B !== (q[n].lineDashType || m.lineDashType)) &&
                    ((C = q[n].lineColor || E),
                  ...
                  if (
                    0 !== q[n].markerSize &&
                    (0 < q[n].markerSize || 0 < m.markerSize)
                  ) {
                    var Q = m.getMarkerProperties(n, f, l, b);
                    r.push(Q);
                    L = U(L);
                    v &&
                      r.push({
              ...
              if (
                ...
                "number" !== typeof l[w].y
                  ...
                  : ((y = a.axisX.convertValueToPixel(z)),
                    ...
                    w < l.length - 1 &&
                      (A !== (l[w].lineColor || t) ||
                        L !== (l[w].lineDashType || f.lineDashType)) &&
                      (b(),
                      (A = l[w].lineColor || t),
                      (h.strokeStyle = A),
                      h.setLineDash &&
                        (l[w].lineDashType
                          ? ((L = l[w].lineDashType),
                            h.setLineDash(H(L, f.lineThickness)))
                          : ((L = f.lineDashType), h.setLineDash(D)))),
                    (z = f.dataPointIds[w]),
                    ...
                    0 !== l[w].markerSize &&
                      (0 < l[w].markerSize || 0 < f.markerSize) &&
                      ((aa = f.getMarkerProperties(w, y, s, h)),
                      p.push(aa),
                      (z = U(z)),
                      v &&
                        p.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], E = 0; E < a.dataSeriesIndexes.length; E++) {
          ...
          for (n = 0; n < t.length; n++)
            (C = t[n].x.getTime ? t[n].x.getTime() : t[n].x),
              (B.dataPointIndexes[C] = n),
              e[C] || (m.push(C), (e[C] = !0));
          m.sort(Sa);
        }
            ...
            for (var aa = !0, n = 0; n < m.length; n++) {
              ...
              if (
                ...
                if ("number" !== typeof ha.y)
                  ...
                  n < t.length - 1 &&
                    (L !== (t[n].lineColor || A) ||
                      u !== (t[n].lineDashType || B.lineDashType)) &&
                    (g(),
                    b.beginPath(),
                    b.moveTo(f, l),
                    k.push({ x: f, y: w - oa }),
                    ...
                    b.setLineDash &&
                      (t[n].lineDashType
                        ? ((u = t[n].lineDashType),
                          b.setLineDash(H(u, B.lineThickness)))
                        : ((u = B.lineDashType), b.setLineDash(D))));
                  ...
                  0 <= B.dataPointIndexes[h] &&
                    0 !== ha.markerSize &&
                    (0 < ha.markerSize || 0 < B.markerSize) &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          for (n = 0; n < A.length; n++)
            (C = A[n].x.getTime ? A[n].x.getTime() : A[n].x),
              (B.dataPointIndexes[C] = n),
              e[C] || (m.push(C), (e[C] = !0));
          m.sort(Sa);
        }
            ...
            for (var aa = !0, n = 0; n < m.length; n++) {
              ...
              if (
                ...
                if ("number" !== typeof ha.y)
                  ...
                  n < A.length - 1 &&
                    (L !== (A[n].lineColor || D) ||
                      s !== (A[n].lineDashType || B.lineDashType)) &&
                    (g(),
                    b.beginPath(),
                    b.moveTo(f, l),
                    k.push({ x: f, y: z - la }),
                    ...
                    b.setLineDash &&
                      (A[n].lineDashType
                        ? ((s = A[n].lineDashType),
                          b.setLineDash(H(s, B.lineThickness)))
                        : ((s = B.lineDashType), b.setLineDash(fa))));
                  if (0 <= B.dataPointIndexes[h]) {
              ...
              if (
                ...
                var f = n[e].z,
                  y =
                    ...
                    Math.max(
                      Math.sqrt(
                        (d === p ? w / 2 : l + ((w - l) / (d - p)) * (f - p)) /
                          Math.PI
                      ) << 0,
                      1
                    ),
                  f = q.getMarkerProperties(e, c);
                f.size = y;
        ...
        for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
          ...
          if (0 < m.length) {
            ...
            for (var q = 0, n = 0, e = 0; e < m.length; e++)
              if (
                ((h = m[e].getTime ? (h = m[e].x.getTime()) : (h = m[e].x)),
                !(
                  h < a.axisX.dataInfo.viewPortMin ||
                  h > a.axisX.dataInfo.viewPortMax
                ) && "number" === typeof m[e].y)
            ...
            for (
              ...
              if (
                ...
                var E = (l - t / 2) << 0,
                  ...
                  B = Math.round(Math.max(1, 0.15 * t)),
                  A = 0 === B % 2 ? 0 : 0.5,
                  D = s.dataPointIds[d];
                ...
                "candlestick" === s.type
                  ? (c.moveTo(l - A, m),
                    c.lineTo(l - A, Math.min(k, n)),
                    c.stroke(),
                    c.moveTo(l - A, Math.max(k, n)),
                    c.lineTo(l - A, q),
                    c.stroke(),
                    ea(
                      c,
                    ...
                    v &&
                      ...
                      (b.strokeStyle = e),
                      b.moveTo(l - A, m),
                      b.lineTo(l - A, Math.min(k, n)),
                      b.stroke(),
                      b.moveTo(l - A, Math.max(k, n)),
                      b.lineTo(l - A, q),
                      b.stroke(),
                      ea(
                        b,
                ...
                (z[d].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: z[d],
                    dataSeries: s,
                    point: { x: E + (C - E) / 2, y: a.axisY.reversed ? q : m },
                    direction: 1,
                    bounds: {
                      x1: E,
                      y1: Math.min(m, q),
    ...
    l.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          if (0 < u.length)
            for (
              var E = 5 < t && z.bevelEnabled ? !0 : !1, r = 0;
              r < u.length;
              r++
            )
              if (
                (u[r].getTime ? (f = u[r].x.getTime()) : (f = u[r].x),
                !(
                  f < a.axisX.dataInfo.viewPortMin ||
                  f > a.axisX.dataInfo.viewPortMax
                ) &&
                ...
                var C = (d - t / 2) << 0,
                  B = (d + t / 2) << 0,
                  e = u[r].color ? u[r].color : z._colorSet[0],
                  ...
                  Q =
                    "number" === typeof u[r].whiskerThickness
                      ...
                      ? z.whiskerThickness
                      : A,
                  fa = u[r].whiskerDashType
                    ? u[r].whiskerDashType
                    : z.whiskerDashType,
                  aa = p(u[r].whiskerLength)
                  ...
                  I = u[r].stemDashType ? u[r].stemDashType : z.stemDashType,
                  K = u[r].lineColor
                    ? u[r].lineColor
                    : u[r].color
                    ? z.lineColor
                  ...
                  P =
                    "number" === typeof u[r].lineThickness
                      ...
                      ? z.lineThickness
                      : A,
                  S = u[r].lineDashType ? u[r].lineDashType : z.lineDashType,
                  M = 1 === Math.round(P) % 2 ? 0.5 : 0,
                  O = z.upperBoxColor,
                  T = z.lowerBoxColor,
                  ua = p(z.options.fillOpacity) ? 1 : z.fillOpacity,
                  R = z.dataPointIds[r];
                this._eventManager.objectMap[R] = {
                  id: R,
                  objectType: "dataPoint",
                ...
                0 < la &&
                  ...
                  (c.strokeStyle = oa),
                  (c.lineWidth = la),
                  c.setLineDash && c.setLineDash(H(I, la)),
                  c.moveTo(d - F, k),
                  c.lineTo(d - F, l),
                  c.stroke(),
                  c.moveTo(d - F, q),
                ...
                0 < P &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(H(S, P)),
                  (c.strokeStyle = K),
                  (c.lineWidth = P),
                  c.moveTo(C, n - M),
                  c.lineTo(B, n - M),
                ...
                0 < Q &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(H(fa, Q)),
                  (c.strokeStyle = L),
                  (c.lineWidth = Q),
                  c.moveTo((d - aa / 2) << 0, q - ha),
                  c.lineTo((d + aa / 2) << 0, q - ha),
                  c.stroke(),
                ...
                v &&
                  ...
                  0 < la &&
                    (b.moveTo(d - D - F, k),
                    b.lineTo(d - D - F, Math.max(l, q)),
                    b.stroke(),
                    b.moveTo(d - D - F, Math.min(l, q)),
                    b.lineTo(d - D - F, m),
                    b.stroke()),
                  ea(
                    b,
                  ...
                  0 < Q &&
                    (b.beginPath(),
                    (b.lineWidth = Q),
                    b.moveTo(d + aa / 2, q - ha),
                    b.lineTo(d - aa / 2, q - ha),
                    b.stroke(),
                ...
                (u[r].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: u[r],
                    dataSeries: z,
                    point: { x: C + (B - C) / 2, y: a.axisY.reversed ? l : q },
                    direction: 1,
                    bounds: {
                      x1: C,
                      y1: Math.min(l, q),
    ...
    l.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < f.length)
            for (
              var t = 5 < k && n.bevelEnabled ? !0 : !1, h = 0;
              h < f.length;
              h++
            )
              if (
                ...
                var w = a.axisX.reversed
                  ...
                  b = f[h].color
                    ? f[h].color
                    : n._colorSet[h % n._colorSet.length];
                if (r > d) {
                  var s = r;
                  r = d;
                  d = s;
    ...
    l.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
          ...
          if (B)
            for (e = E._linkedSeries.id, s = 0; s < e; s++)
              !this.data[s].type.match(/(bar|column)/gi) ||
                ...
                (this.data[s].type.match(/(range)/gi) && (h = !0), D++);
          e = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
          ...
          s > d && (s = d);
          if (0 < C.length)
            for (var H = E._colorSet, d = 0; d < C.length; d++) {
              var e = (E.lineColor = E.options.color ? E.options.color : H[0]),
                L = {
              ...
              if (
                ...
                b ? (k = fa) : (l = fa);
                fa = a.axisY.convertValueToPixel(C[d].y[0]);
                b ? (m = fa) : (n = fa);
                fa = a.axisY.convertValueToPixel(C[d].y[1]);
                b ? (q = fa) : (f = fa);
                b
                  ? ((n = a.axisX.reversed
                      ? (k + ((B ? y : 1) * s) / 2 - (B ? D - 1 : 0) * s) << 0
                      : (k - ((B ? y : 1) * s) / 2 + (B ? D - 1 : 0) * s) << 0),
                    (f = a.axisX.reversed ? (n - s) << 0 : (n + s) << 0))
                  : ((m = a.axisX.reversed
                      ? (l + ((B ? y : 1) * s) / 2 - (B ? D - 1 : 0) * s) << 0
                      : (l - ((B ? y : 1) * s) / 2 + (B ? D - 1 : 0) * s) << 0),
                ...
                v && A(this._eventManager.ghostCtx, m, n, q, f, e, L, Q, b);
                if (
                  C[d].indexLabel ||
                  E.indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    point: {
                      ...
                      y: b ? n + (f - n) / 2 : C[d].y[1] >= C[d].y[0] ? f : n,
                    },
                      ...
                      point: {
                        x: b
                          ? C[d].y[1] >= C[d].y[0]
                            ...
                            : m
                          : m + (q - m) / 2,
                        y: b ? n + (f - n) / 2 : C[d].y[1] >= C[d].y[0] ? n : f,
                      },
                      direction: C[d].y[1] >= C[d].y[0] ? 1 : -1,
                      bounds: {
                        x1: b ? Math.min(m, q) : m,
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                ea(
                  c,
                  r,
                  a.axisX.reversed ? y : l,
                  d,
                  a.axisX.reversed ? l : y,
                  b,
                  0,
                  null,
                  w,
      ...
      function g() {
        if (z) {
          for (var a = null, c = p.length - 1; 0 <= c; c--)
            (a = p[c]), b.lineTo(a.x, a.y2), e.lineTo(a.x, a.y2);
          b.closePath();
          b.globalAlpha = m.fillOpacity;
          b.fill();
          b.globalAlpha = 1;
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
          ...
          var h = [],
            ...
            z = null;
          if (0 < q.length) {
            var u = m._colorSet[f % m._colorSet.length],
              t = (m.lineColor = m.options.lineColor || u),
              C = t;
            b.fillStyle = u;
            b.strokeStyle = t;
            b.lineWidth = m.lineThickness;
            ...
            for (var L = !0; f < q.length; f++)
              if (
                ...
                if (
                  ...
                  f < q.length - 1 &&
                    (C !== (q[f].lineColor || t) ||
                      B !== (q[f].lineDashType || m.lineDashType)) &&
                    (g(),
                    (C = q[f].lineColor || t),
                    ...
                    b.setLineDash &&
                      (q[f].lineDashType
                        ? ((B = q[f].lineDashType),
                          (p[p.length - 1].newLineDashArray = H(
                            B,
                            m.lineThickness
                          )),
                  ...
                  if (
                    0 !== q[f].markerSize &&
                    (0 < q[f].markerSize || 0 < m.markerSize)
                  ) {
                    var Q = m.getMarkerProperties(f, l, y, b);
                    h.push(Q);
                    var fa = U(s);
                    v &&
                      h.push({
                    ...
                    Q = m.getMarkerProperties(f, l, w, b);
                    h.push(Q);
                    fa = U(s);
                    v &&
                      h.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
          ...
          var h = [],
            ...
            y = [];
          if (0 < m.length) {
            var s = k._colorSet[q % k._colorSet.length],
            ...
            var E = "solid",
              C;
            if (b.setLineDash) {
              var B = H(k.nullDataLineDashType, k.lineThickness),
                E = k.lineDashType;
              C = H(E, k.lineThickness);
            }
            for (f = !1; q < m.length; q++)
              if (
                ((n = m[q].x.getTime ? m[q].x.getTime() : m[q].x),
                !(
                ...
                if (
                  ...
                  q < m.length - 1 &&
                    (u !== (m[q].lineColor || z) ||
                      E !== (m[q].lineDashType || k.lineDashType)) &&
                    ((u = m[q].lineColor || z),
                    (w[w.length - 1].newStrokeStyle = u),
                    b.setLineDash &&
                      (m[q].lineDashType
                        ? ((E = m[q].lineDashType),
                          (w[w.length - 1].newLineDashArray = H(
                            E,
                            k.lineThickness
                          )))
                        : ((E = k.lineDashType),
                  ...
                  if (
                    0 !== m[q].markerSize &&
                    (0 < m[q].markerSize || 0 < k.markerSize)
                  ) {
                    var D = k.getMarkerProperties(q, n, f, b);
                    h.push(D);
                    var L = U(A);
                    v &&
                      h.push({
        ...
        for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
          ...
          if (0 < y.length)
            for (
              ...
              if (
                (y[r].getTime ? (m = y[r].x.getTime()) : (m = y[r].x),
                "number" !== typeof y[r].y)
              ) {
                if (0 < r && !t && w.connectNullData)
                  var A =
                    w.options.nullDataLineDashType || !y[r - 1].lineDashType
                ...
                var Q,
                  L = d;
                Q =
                  ("undefined" !== typeof y[r].isIntermediateSum &&
                    !0 === y[r].isIntermediateSum) ||
                  ("undefined" !== typeof y[r].isCumulativeSum &&
                    !0 === y[r].isCumulativeSum)
                    ? 0 < y[r].y
                      ? p
                      : k
                    : 0 < y[r].y
                ...
                0 < r &&
                  C &&
                  (!t || w.connectNullData) &&
                  (t && c.setLineDash && c.setLineDash(H(A, s)),
                  c.beginPath(),
                  c.moveTo(C, B - z),
                  c.lineTo(L, Q - z),
                  0 < s && c.stroke(),
                ...
                (y[r].indexLabel ||
                  w.indexLabel ||
                  y[r].indexLabelFormatter ||
                  w.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: "waterfall",
                    dataPoint: y[r],
                    dataSeries: w,
                    point: { x: d + (D - d) / 2, y: 0 <= y[r].y ? p : k },
    ...
    l.prototype.renderPie = function (a) {
        ...
        if (k && m) {
          ...
          for (var g = 0; g < m.length; g++) {
            ...
            q = h.indexLabelFormatter
              ? h.indexLabelFormatter(x)
              : h.indexLabel
              ? l.replaceKeywordsWithValue(h.indexLabel, h, k, g)
              : k.indexLabelFormatter
              ? k.indexLabelFormatter(x)
              : k.indexLabel
              ? l.replaceKeywordsWithValue(k.indexLabel, h, k, g)
              : h.label
              ? h.label
              : "";
      ...
      function c(a, b) {
        ...
        for (c = 0; c < m.length; c++) {
          var g = f[c].startAngle,
            e = f[c].endAngle;
          if (e > g) {
            var h = 0.07 * B * Math.cos(f[c].midAngle),
              d = 0.07 * B * Math.sin(f[c].midAngle),
              r = !1;
            if (m[c].exploded) {
              if (
          ...
          (e = f[g]),
            e.indexLabelText &&
              ...
              "inside" !== e.indexLabelPlacement &&
                ...
                (d = e.center.y + B * Math.sin(e.midAngle)),
                (c.strokeStyle = e.indexLabelLineColor),
                (c.lineWidth = e.indexLabelLineThickness),
                c.setLineDash &&
                  c.setLineDash(
                    H(e.indexLabelLineDashType, e.indexLabelLineThickness)
                  ),
                c.beginPath(),
                c.moveTo(h, d),
                c.lineTo(e.indexLabelTextBlock.x, e.indexLabelTextBlock.y),
                c.lineTo(
                  e.indexLabelTextBlock.x + ("left" === e.hemisphere ? -q : q),
                  e.indexLabelTextBlock.y
                ),
                c.stroke()),
              (c.lineJoin = "miter"));
      ...
      function b(a, b) {
        ...
        return (c =
          b.indexLabelTextBlock.y > a.indexLabelTextBlock.y ? f - e : c - g);
      }
      function e(a) {
        ...
        if (0 <= a && a < m.length) {
          ...
          r =
            "right" === n.hemisphere
              ...
              : u.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - u.y, 2));
          p = u.x + B * Math.cos(n.midAngle);
          q = u.y + B * Math.sin(n.midAngle);
          ...
          for (k = 1; k < m.length; k++)
            if (
              ((r = (a - k + f.length) % f.length),
              f[r].hemisphere !== f[a].hemisphere)
            ) {
              r = null;
              break;
            } else if (
              ...
              (0 > b(f[r], f[a]) ||
                ("right" === f[a].hemisphere
                  ? f[r].indexLabelTextBlock.y <= f[a].indexLabelTextBlock.y
                  : f[r].indexLabelTextBlock.y >= f[a].indexLabelTextBlock.y))
            )
              break;
            else r = null;
      ...
      function r() {
        ...
        for (
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (var p, s, a = 0; a < m.length; a++) {
              ...
              if (null !== x) {
                ...
                var t = 0,
                  t = b(p, s) - v;
                if (0 > t) {
                  for (var C = (s = 0), E = 0; E < m.length; E++)
                    E !== a &&
                      f[E].hemisphere === d.hemisphere &&
                      (f[E].indexLabelTextBlock.y < d.indexLabelTextBlock.y
                        ? s++
                        : C++);
                  s = (t / (s + C || 1)) * C;
                  var C = -1 * (t - s),
                  ...
                  "right" === d.hemisphere
                    ? ((E = h(a, s)),
                      (C = -1 * (t - E)),
                      (H = h(x, C)),
                      +H.toFixed(z) < +C.toFixed(z) &&
                        +E.toFixed(z) <= +s.toFixed(z) &&
                        h(a, -(C - H)))
                    : ((E = h(x, s)),
                      (C = -1 * (t - E)),
                      (H = h(a, C)),
            ...
            for (a = 0; a < m.length; a++)
              (d = f[a]),
                ...
                (x = u.x + w * Math.cos(d.midAngle)),
                (s = u.y + w * Math.sin(d.midAngle)),
                (d.indexLabelTextBlock.x = x),
                (d.indexLabelTextBlock.y = s);
          for (a = 0; a < m.length; a++)
            if (
              ((d = f[a]),
              (x = d.indexLabelTextBlock.measureText()),
              ...
              (x = x = 0),
                ...
                0 < x &&
                  (!r &&
                    ...
                    ((s =
                      "right" === d.hemisphere
                        ? n.x2 - d.indexLabelTextBlock.x
                        : d.indexLabelTextBlock.x - n.x1),
                  ...
                  ((x /= Math.abs(Math.cos(d.indexLabelAngle))),
                  9 < x && (x *= 0.3),
                  x > g && (g = x)),
                (x = x = 0),
                  ...
                  (!r &&
                    ...
                    ((s =
                      0 < d.indexLabelAngle && d.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === h(a, x * s) && h(a, 2 * s)),
                  Math.abs(d.indexLabelTextBlock.x - u.x) < B &&
                    ((x /= Math.abs(Math.sin(d.indexLabelAngle))),
                    9 < x && (x *= 0.3),
                    x > g && (g = x)));
          ...
          (function () {
            for (var a = -1, c = -1, g = 0, h = !1, d = 0; d < m.length; d++)
              if (((h = !1), (p = f[d]), p.indexLabelText)) {
                var r = e(d);
                if (null !== r) {
                  var k = f[r];
                  t = 0;
    ...
    l.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        f = Math.abs(f);
        f = e + f;
        for (var e = [], h = 0, d = 0; d < z.length; d++) {
        ...
        if (0 === h) return -1;
        for (
          var r = (e[0] = 0), k = 0, m, n, b = b - a, r = !1, d = 0;
          d < z.length;
          d++
        )
          (a = (Math.abs(z[d].y) * f) / h),
            r
        ...
        if (s && z) {
          for (
            ...
            (u = R[B]),
              ...
              (w[B] = K - u - T);
          u = 0.5 * T;
          for (var B = 0, A = z.length - 1; B < z.length || 0 <= A; B++, A--) {
            b = s.reversed ? z[A] : z[B];
            a = b.color
              ? b.color
              : s.reversed
            ...
            p(s.options.indexLabelMaxWidth) &&
              (s.indexLabelMaxWidth = p(s.indexLabelMaxWidth)
                ? l
                : Math.max(l, s.indexLabelMaxWidth));
            U.roundRect || za(U);
            c = new ka(U, {
              fontSize: h,
              fontFamily: r,
      ...
      function e() {
        ...
        if (e)
          for (r = G.length - 1; 0 <= r; r--)
            (a = R[r]),
              (G[r].textBlock.maxWidth = f[f.length - (r + 1)]),
              ...
              s.reversed
                ? (G[r].textBlock.y + G[r].height > V + E &&
                    (G[r].textBlock.y = V + E - G[r].height),
                  G[r].textBlock.y < ua - E && (G[r].textBlock.y = ua - E))
                : (G[r].textBlock.y < V - E && (G[r].textBlock.y = V - E),
                  G[r].textBlock.y + G[r].height > ua + E &&
                    (G[r].textBlock.y = ua + E - G[r].height));
      }
      function h() {
        var a, b, c, g;
          ...
          for (var e = 0; e < R.length; e++)
            0 == G[e].textBlock.text.length
              ...
              : ((a = R[e]),
                ...
                s.reversed
                  ? (G[e].textBlock.y + G[e].height > V + E &&
                      (G[e].textBlock.y = V + E - G[e].height),
                    G[e].textBlock.y < ua - E && (G[e].textBlock.y = ua - E))
                  : (G[e].textBlock.y < V - E && (G[e].textBlock.y = V - E),
                    G[e].textBlock.y + G[e].height > ua + E &&
                      (G[e].textBlock.y = ua + E - G[e].height)));
        else
      ...
      function d() {
        ...
        function b() {
          ...
          for (var r, k = 1; k < d; k++) {
            ...
            for (var p = G.length - 1; 0 <= p; p--)
              !G[p].isDirty &&
                G[p].textBlock.y < g &&
                G[p].textBlock.y + G[p].height > g &&
                ((r = n(p)),
                !(r >= G.length - 1) &&
                  G[p].textBlock.y + G[p].height + da > G[r].textBlock.y &&
                  (G[p].textBlock.y =
                    G[p].textBlock.y + G[p].height - g > g - G[p].textBlock.y
                      ? g + 1
                      : g - G[p].height - 1));
          }
          for (r = R.length - 1; 0 < r; r--)
            if (!G[r].isDirty) {
              g = q(r);
              if (0 > g && ((g = 0), G[g].isDirty)) break;
              if (G[r].textBlock.y < G[g].textBlock.y + G[g].height) {
                e = e || r;
                f = r;
                for (
                  d = 0;
                  G[f].textBlock.y < G[g].textBlock.y + G[g].height + da;
        ...
        for (var e, g, f, h, r, k, m = 1, p = 0; p < 2 * m; p++) {
          for (
            var s = G.length - 1;
            0 <= s &&
            !(0 <= q(s) && q(s),
            (f = G[s]),
            (h = f.textBlock),
            (k = (r = n(s) < R.length ? G[n(s)] : null) ? r.textBlock : null),
            (e = +f.height.toFixed(6)),
            (g = +h.y.toFixed(6)),
            !f.isDirty &&
              r &&
              g + e + da > +k.y.toFixed(6) &&
              ((e = h.y + e + da - k.y),
              (g = a(s, -e)),
              g < e && (0 < g && (e -= g), (g = a(n(s), e)), g != e)));
            s--
          );
          b();
        }
      ...
      function l(a, b) {
        return (
          (b < R.length ? G[b].textBlock.y : s.reversed ? V + E : ua + E) -
          (0 > a
            ? s.reversed
              ? ua - E
              : V - E
            : G[a].textBlock.y + G[a].height + da)
        );
      }
      function t(a, b, c) {
        var e,
        ...
        if (0 === W.length) d = ja;
          ...
          for (var q = 0; q < R.length; q++) {
            ...
            d.push(ja[q] + e);
            if (0 <= W.indexOf(q) || (q < R.length && 0 <= W.indexOf(q + 1)))
              e += g;
          }
        }
        f = (function () {
        ...
        a._animator.animate(
          ...
          function (c) {
            ...
            for (g = 0; g < R.length; g++) sa(e, R[g], s.fillOpacity);
            w(e);
            L && ("inside" !== s.indexLabelPlacement ? m(e) : h(), A(e));
            1 <= c && (ia = !1);
          },
          null,
      ...
      function m(a) {
        for (var b, c, e, g, h = 0; h < R.length; h++)
          (g = 1 === G[h].lineThickness % 2 ? 0.5 : 0),
            (c = (((R[h].y2 + R[h].y4) / 2) << 0) + g),
            (b = f(c).x2 - 1),
            (e = G[h].textBlock.x),
            (g = ((G[h].textBlock.y + G[h].height / 2) << 0) + g),
            G[h].isDirty ||
              0 == G[h].lineThickness ||
              ((a.strokeStyle = G[h].lineColor),
              (a.lineWidth = G[h].lineThickness),
              a.setLineDash &&
                a.setLineDash(H(G[h].lineDashType, G[h].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(e, g),
              a.stroke());
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var s = this.data[a.dataSeriesIndexes[0]],
            ...
            B = 0,
            D = u.height - 2 * E,
            I = Math.min(u.width - 2 * C, 2.8 * u.height),
            L = !1,
            Q = 0;
          Q < z.length;
          Q++
          ...
          if (
            (!L &&
              "undefined" !== typeof z[Q].indexLabel &&
              null !== z[Q].indexLabel &&
              0 < z[Q].indexLabel.toString().length &&
              (L = !0),
            !L &&
              "undefined" !== typeof z[Q].label &&
              null !== z[Q].label &&
              0 < z[Q].label.toString().length &&
              (L = !0),
            (!L && "function" === typeof s.indexLabelFormatter) ||
              "function" === typeof z[Q].indexLabelFormatter)
          )
            L = !0;
        L =
          L ||
        ...
        if (0 != s.length && s.dataPoints && s.visible && 0 !== z.length) {
          ...
          var T = (30 * (K - a)) / 100;
          "funnel" === s.type
            ? ((O = p(s.options.neckHeight) ? 0.35 * D : s.neckHeight),
              (F = p(s.options.neckWidth) ? 0.25 * a : s.neckWidth),
              "string" === typeof O && O.match(/%$/)
                ? ((O = parseInt(O)), (O = (O * D) / 100))
                : (O = parseInt(O)),
              ...
              F > a ? (F = a - 0.5) : 0 >= F && (F = 0))
            : "pyramid" === s.type &&
              ((F = O = 0), (s.reversed = s.reversed ? !1 : !0));
          var C = Q + a / 2,
            X = Q,
            Z = Q + a,
            V = s.reversed ? S : P,
          ...
          if (-1 !== Q) {
            if (s.reversed)
              for (I.push(Y), F = Q.length - 1; 0 < F; F--)
                (Y += Q[F]), I.push(Y);
            else for (F = 0; F < Q.length; F++) (Y += Q[F]), I.push(Y);
            if (s.reversed)
              for (F = 0; F < Q.length; F++)
                I[F] < $
                  ? (a.push(M), C.push(ba), (ea = F))
                  : (a.push((I[F] - V + ca * X) / ca),
                    C.push((I[F] - V + ga * Z) / ga));
            else
              for (F = 0; F < Q.length; F++)
                I[F] < $
                  ? (a.push((I[F] - V + ca * X) / ca),
            ...
            for (F = 0; F < Q.length - 1; F++)
              (Y = s.reversed
                ? z[z.length - 1 - F].color
                  ? z[z.length - 1 - F].color
                  : s._colorSet[(z.length - 1 - F) % s._colorSet.length]
                : z[F].color
                ? z[F].color
            ...
            for (F = 0; F < z.length; F++)
              z[F].exploded &&
                ((Q = !0), s.reversed ? W.push(z.length - 1 - F) : W.push(F));
            U.clearRect(u.x1, u.y1, u.width, u.height);
            U.fillStyle = y.backgroundColor;
            U.fillRect(u.x1, u.y1, u.width, u.height);
            if (
              L &&
              s.visible &&
              ...
              for (F = 0; F < R.length; F++)
                (R[F].x1 += B),
                  ...
                  (R[F].x3 += B),
                  (R[F].x4 += B),
                  R[F].x5 && ((R[F].x5 += B), (R[F].x6 += B)),
                  (G[F].textBlock.x += B);
            }
            for (F = 0; F < R.length; F++)
              (B = R[F]), sa(U, B, s.fillOpacity), ja.push(B.y1);
            w(U);
            L &&
              s.visible &&
              ("inside" === s.indexLabelPlacement || y.animationEnabled || m(U),
            ...
            !y.animationEnabled && Q
              ? t(y, -1, 0)
              : y.animationEnabled && !y.animatedRender && t(y, -1, 0);
      ...
      if (b && g && c) {
        ...
        if ("undefined" !== typeof Blob && new Blob()) {
          for (
            ...
            p[l] = d.charCodeAt(l);
          g = new Blob([p.buffer], { type: "image/" + g });
          try {
    ...
    l.prototype.replaceKeywordsWithValue = function (a, g, c, b, e) {
      ...
      if (
        ...
        do {
          ...
          a = a.replace("#percent", da(d, l, h._cultureInfo));
          a = a.replace(
            "#total",
            da(
              p,
            ...
            var n = (q.legendMarkerType = q.legendMarkerType
                ...
                ? "error" === q.type && q._linkedSeries
                  ? q._linkedSeries.legendMarkerType
                    ? q._linkedSeries.legendMarkerType
                    : X.getDefaultLegendMarker(q._linkedSeries.type)
                  : X.getDefaultLegendMarker(q.type)
                : q.markerType),
              f = q.legendText
                ? q.legendText
                ...
                : q.name,
              t = (q.legendMarkerColor = q.legendMarkerColor
                ? q.legendMarkerColor
                : q.markerColor
                ? q.markerColor
                : "error" === q.type
            ...
            for (var z = 0; z < q.dataPoints.length; z++) {
              var u = q.dataPoints[z],
                ...
                s = u.legendMarkerBorderThickness
                  ...
                  : q.legendMarkerBorderThickness
                  ? q.legendMarkerBorderThickness
                  : u.markerBorderThickness || q.markerBorderThickness
                  ? Math.max(1, Math.round(0.2 * w))
                  : 0,
                f = this.chart.replaceKeywordsWithValue(f, u, q, z),
                n = {
                  markerType: n,
                  markerColor: t,
                  text: f,
              ...
              (u.showInLegend || (q.showInLegend && !1 !== u.showInLegend)) &&
                v.push(n);
            }
      }
        ...
        for (m = 0; m < v.length; m++) {
          ...
          if (
            ...
            if ("horizontal" === this.orientation) {
              ...
              f = Math.max(
                f,
                n.textBlock.height ? n.textBlock.height : this.lineHeight
              );
              ...
              (n.textBlock = new ka(this.ctx, {
                ...
                this.height < d - this.lineHeight
                  ? ((q = { items: [], width: 0 }), k.push(q))
                  : ((q = k[z]), (z = (z + 1) % k.length)),
                q &&
    ...
    S.prototype.render = function () {
      ...
      for (var p = 0, l = 0; l < d.length; l++) {
        for (var k = d[l], m = 0, q = 0; q < k.items.length; q++) {
          var n = k.items[q],
            f =
              n.textBlock.x + a + (0 === q ? 0.2 * h : this.horizontalSpacing),
            v = g + p,
            w = f;
          ...
          if ("error" === n.chartType) {
            ...
            this.ctx.beginPath();
            var y = f - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
          ...
          this.ghostCtx.fillRect(
            ...
            n.textBlock.x + n.textBlock.width - w,
            n.textBlock.height ? n.textBlock.height : this.lineHeight
          );
        ...
        if (0 <= h && h < this.dataPoints.length) {
          var b = this.dataPoints[h],
            q = this.axisX.logarithmic
              ...
              : Math.abs(b.x - a);
          q < c.distance &&
            ((c.dataPoint = b), (c.distance = q), (c.index = h));
          b = q;
          b <= p ? (p = b) : 0 < d ? l++ : k++;
    ...
    X.prototype.getDataPointAtXY = function (a, g, c) {
      ...
      for (;;) {
        h = 0 < d ? q + e : q - e;
        if (0 <= h && h < this.dataPoints.length) {
          var n = this.chart._eventManager.objectMap[this.dataPointIds[h]],
            f = this.dataPoints[h],
            t = null;
          if (n) {
            switch (this.type) {
              ...
              case "scatter":
                var w = na("markerSize", f, this) || 4,
                  y = c ? 20 : w,
                  t = Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y1 - g, 2));
                t <= y &&
                  b.push({
                    dataPoint: f,
                    dataPointIndex: h,
              ...
              case "rangeSplineArea":
                ...
                y = c ? 20 : w;
                t = Math.min(
                  Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y1 - g, 2)),
                  Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y2 - g, 2))
                );
                t <= y &&
                  b.push({
                    dataPoint: f,
              ...
              case "boxAndWhisker":
                if (
                  (a >= n.x1 - n.borderThickness / 2 &&
                    ...
                    g >= n.y4 - n.borderThickness / 2 &&
                    g <= n.y1 + n.borderThickness / 2) ||
              ...
              case "candlestick":
                if (
                  (a >= n.x1 - n.borderThickness / 2 &&
                    a <= n.x2 + n.borderThickness / 2 &&
                    g >= n.y2 - n.borderThickness / 2 &&
                    g <= n.y3 + n.borderThickness / 2) ||
                  (Math.abs(n.x2 - a + n.x1 - a) < n.borderThickness &&
                    g >= n.y1 &&
                    g <= n.y4)
                )
            ...
            (h =
              0 === this.labelAngle
                ...
                : e.width *
                  ...
                  (e.height - b.fontSize / 2) *
                    Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))),
            "inside" === this.tickPlacement && (h += this.tickLength),
            "inside" === this.labelPlacement && (a += 0 < this._index ? h : 0),
            a < h && (a = h),
    ...
    D.setLayout = function (a, g, c, b, e, h) {
      var d,
        ...
        t,
        k,
        m = a[0] ? a[0].chart : g[0].chart,
        q = m.isNavigator ? 0 : 10,
        n = m._axes;
      if (a && 0 < a.length)
      ...
      for (f = 0; f < n.length; f++)
        if (n[f] && n[f].scaleBreaks && n[f].scaleBreaks._appliedBreaks.length)
          for (
            var v = n[f].scaleBreaks._appliedBreaks, w = 0;
            w < v.length && !(v[w].startValue > n[f].viewportMaximum);
            w++
          )
            v[w].endValue < n[f].viewportMinimum ||
              (p(n[f].scaleBreaks.firstBreakIndex) &&
                (n[f].scaleBreaks.firstBreakIndex = w),
              v[w].startValue >= n[f].viewPortMinimum &&
        ...
        if (n[f].title)
          switch (n[f]._position) {
            ...
            case "right":
              ...
              break;
            default:
              (n[f]._titleTextBlock.maxWidth = n[f].titleMaxWidth || h.width),
                (n[f]._titleTextBlock.maxHeight = n[f].titleWrap
                  ? 0.8 * h.height
                  : 1.5 * n[f].titleFontSize),
      ...
      if ("normal" === e) {
        for (
          ...
          if (c && 0 < c.length)
            for (A = [], f = R = 0; f < c.length; f++)
              A.push(
                ...
                (R += A[f]),
                (M += c[f] && !m.isNavigator ? c[f].margin : 0);
          else
          ...
          t = Math.round(
            h.x2 - $ - Z > m.width - q ? m.width - q : h.x2 - $ - Z
          );
          if (a && 0 < a.length)
          ...
          if (g && 0 < g.length)
            for (u = [], f = Y = 0; f < g.length; f++)
              g[f] && (g[f].lineCoordinates = {}),
                ...
                (Y += u[f]),
                (X += g[f] && !m.isNavigator ? g[f].margin : 0);
          else
          ...
          if (g && 0 < g.length)
            for (f = 0; f < g.length; f++)
              (g[f].lineCoordinates.x1 = Math.round(h.x1 + R + M)),
                ...
                g[f]._labels &&
                  ...
                  (s =
                    ...
                    (l.textBlock.height - l.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(l.textBlock.angle)))),
                m.panEnabled
                  ? (Y = p(m.sessionVariables.axisX2.height)
                      ? (m.sessionVariables.axisX2.height = Y)
                      : m.sessionVariables.axisX2.height)
                  : (m.sessionVariables.axisX2.height = Y),
                (l = Math.round(h.y1)),
                (k = g[f].lineCoordinates.y1 = l + Y + X - U),
                (g[f].lineCoordinates.y2 = l),
                "inside" === g[f].labelPlacement &&
                  0 < f &&
                  (g[f].lineCoordinates.y1 =
                    g[f - 1].lineCoordinates.y1 -
                    U -
              ...
              b[f] &&
                ...
                (M =
                  b[f]._labels && 0 < b[f]._labels.length
                    ...
                    : 0),
                (l = Math.round(
                  h.y1 + Y + X < Math.max(M, q) ? Math.max(M, q) : h.y1 + Y + X
                )),
                (M =
                  0 < a.length
                    ? 0
        ...
        N = [];
        for (P = []; 4 > w; ) {
          W = V = T = Z = M = X = e = S = O = F = Y = 0;
          if (a && 0 < a.length)
            for (H = [], f = V = 0; f < a.length; f++)
              H.push(
          ...
          if (c && 0 < c.length)
            for (f = 0; f < c.length; f++)
              (c[f].lineCoordinates = {}),
                (d = Math.round(h.x1 + V + e)),
                (t = Math.round(
                  h.x2 - W - X > m.width - 10 ? m.width - 10 : h.x2 - W - X
                )),
                c[f].labelAutoFit &&
                  !p(z) &&
                  (0 < !a.length &&
          ...
          if (m.panEnabled)
            for (f = 0; f < c.length; f++)
              q[f] = p(m.sessionVariables.axisY[f].height)
          ...
          if (c && 0 < c.length)
            for (f = c.length - 1; 0 <= f; f--)
              (l = Math.round(h.y2)),
                ...
                (c[f].lineCoordinates.y1 = l - (q[f] + c[f].margin + Y)),
                (c[f].lineCoordinates.y2 = l - (q[f] + c[f].margin + Y)),
                "inside" === c[f].labelPlacement &&
                  0 < f &&
          ...
          if (b && 0 < b.length)
            for (f = b.length - 1; 0 <= f; f--)
              b[f] &&
                ((l = Math.round(h.y1)),
                (k = Math.round(h.y1 + (B[f] + b[f].margin + F))),
            ...
            for (f = 0; f < a.length; f++) {
              ...
              l =
                b && 0 < b.length
                  ...
                  ? Math.max(M, 10)
                  : h.y1;
              t = Math.round(h.x1 + V + e);
              k =
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ? c[0].lineCoordinates.y1
                        : h.y2 - T > m.height - Math.max(M, 10)
                        ? m.height - Math.max(M, 10)
                        : h.y2 - T
                    )
                  : h.y2 > m.height - Math.max(M, 10)
                  ? m.height - Math.max(M, 10)
                  : h.y2;
              if (c && 0 < c.length)
              ...
              if (b && 0 < b.length)
                for (M = 0; M < b.length; M++)
                  b[M] &&
                    b[M].labelAutoFit &&
                    ((t = b[M].lineCoordinates.x1), (d = t - V));
              a[f].lineCoordinates = {
                x1: t - O,
                y1: l,
                x2: t - O,
            ...
            for (f = 0; f < g.length; f++) {
              ...
              if (b && 0 < b.length)
                for (M = 0; M < b.length; M++)
                  b[M] &&
                    b[M].labelAutoFit &&
                    ((t = b[M].lineCoordinates.x2), (d = t - W));
              g[f].lineCoordinates = {
                x1: t + S,
                y1: l,
                x2: t + S,
          ...
          (q = this._labels[k]),
            q.position < this.viewportMinimum ||
              ...
              this.tickThickness &&
                ...
                this.ctx.beginPath(),
                this.ctx.moveTo(b, n.y << 0),
                this.ctx.lineTo(b, (n.y + this.tickLength) << 0),
                this.ctx.stroke()),
          ...
          (q = this._labels[k]),
            q.position < this.viewportMinimum ||
              ...
              this.tickThickness &&
                ...
                this.ctx.beginPath(),
                this.ctx.moveTo(n.x << 0, b),
                this.ctx.lineTo((n.x - this.tickLength) << 0, b),
                this.ctx.stroke()),
              (g && 0 !== h++ % 2 && this.labelAutoFit) ||
                (0 === this.labelAngle
                  ? ((q.textBlock.y = n.y),
    ...
    D.prototype.renderGrid = function () {
      if (this.gridThickness && 0 < this.gridThickness) {
        ...
        a.setLineDash &&
          a.setLineDash(H(this.gridDashType, this.gridThickness));
        if ("bottom" === this._position || "top" === this._position)
          for (b = 0; b < this._labels.length; b++)
    ...
    D.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          g.setLineDash &&
            g.setLineDash(H(this.lineDashType, this.lineThickness));
          var d =
        ...
        if (this.scaleBreaks && !p(this.scaleBreaks.firstBreakIndex))
          if (p(this.scaleBreaks.lastBreakIndex))
            ...
            for (
              ...
              g.moveTo(d, e),
                g.lineTo(d, this.scaleBreaks._appliedBreaks[l].startPixel + b),
            ...
            (b / 1 <= a
              ...
              : ((this.interval =
                  b / (1 * I.yearDuration) <= a
                    ...
                    ? 4
                    : Math.floor(
                        D.getNiceNumber(b / (a - 1), !0) / I.yearDuration
                      )),
    ...
    D.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      d = Math.pow(
        this.logarithmBase,
        D.getNiceNumber(Math.abs(Math.log(d) / g), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = D.getNiceExponent(Math.log(d) / g / (a - 1), !0)),
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            (l = 1 === q % 2 ? (e.x << 0) + 0.5 : e.x << 0),
            "top" === this.scaleBreaks.parent._position
              ? ((e = this.chart.plotArea.y1),
                (p = (this.chart.plotArea.y2 + q / 2 + 0.5) << 0))
              : ((e = this.chart.plotArea.y2),
                (p = (this.chart.plotArea.y1 - q / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b - q / 2, y1: e, x2: l + q / 2, y2: p }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("top" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("bottom" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(b, p), this.ctx.lineTo(l, p), this.ctx.lineTo(l, e);
          ...
          if (
            ...
            (p = 1 === q % 2 ? (b.y << 0) + 0.5 : b.y << 0),
            "left" === this.scaleBreaks.parent._position
              ? ((b = this.chart.plotArea.x1),
                (l = (this.chart.plotArea.x2 + q / 2 + 0.5) << 0))
              : ((b = this.chart.plotArea.x2),
                (l = (this.chart.plotArea.x1 - q / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b, y1: e - q / 2, x2: l, y2: p + q / 2 }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("left" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("right" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(l, e), this.ctx.lineTo(l, p), this.ctx.lineTo(b, p);
          else if ("wavy" === this.type) {
            t = b;
            k = e;
            d = 0.5;
            ...
            m = (l - t) / a / 2;
            for (n = 0; n < m; n++)
              this.ctx.lineTo(t, k), (k += 2 * d * a), (t += 2 * a), (d *= -1);
            this.ctx.lineTo(t, k);
            k += p - e;
            for (n = 0; n < m + 1; n++)
              this.ctx.lineTo(t, k), (k += 2 * d * a), (t -= 2 * a), (d *= -1);
      ...
      if (0 < g) {
        ...
        if (
          ...
          (e = d = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            ...
            (this.bounds = { x1: e - g / 2, y1: l, x2: d + g / 2, y2: p });
        else if (
          "left" === this.parent._position ||
          "right" === this.parent._position
        )
          (l = p = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            (e = this.chart.plotArea.x1),
            (d = this.chart.plotArea.x2),
            (this.bounds = { x1: e, y1: l - g / 2, x2: d, y2: p + g / 2 });
        this.ctx.moveTo(e, l);
        this.ctx.lineTo(d, p);
        this.ctx.stroke();
    ...
    ca.prototype.render = function (a, g, c) {
      var b,
        e,
        d,
        l,
      ...
      var q = null === this.opacity ? 1 : this.opacity,
        n = Math.abs(
          "pixel" === this._thicknessType
            ? this.thickness
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (
              ...
              if (m[s].dataPoint.y)
                for (var E = 0; E < m[s].dataPoint.y.length; E++)
                  (z = Math.abs(
                    a - this.parent.convertValueToPixel(m[s].dataPoint.y[E])
                  )),
                    z <= w && ((w = z), (y = s));
            } else
          ...
          if (
            ...
            this.bounds = { x1: b - n / 2, y1: d, x2: e + n / 2, y2: l };
            ...
            this.bounds = { x1: b, y1: d - n / 2, x2: e, y2: l + n / 2 };
            s = !1;
            ...
            if (
              ...
              if (m[s].dataPoint.y)
                for (E = 0; E < m[s].dataPoint.y.length; E++)
                  (z = Math.abs(
                    g - this.parent.convertValueToPixel(m[s].dataPoint.y[E])
                  )),
                    z <= w && ((w = z), (y = s));
            } else
              "stackedColumn" === m[s].dataSeries.type
                  ...
                  "stackedColumn100" === m[s].dataSeries.type
                    ? ((v =
                      ...
                      (z = m[s].dataPoint.x.getTime
                        ...
                        : m[s].dataPoint.x),
                      (b =
                        100 * (v / m[s].dataSeries.plotUnit.dataPointYSums[z])),
                      (z = Math.abs(g - this.parent.convertValueToPixel(b))),
                      z <= u && ((u = z), (y = s)))
                    : "stackedArea100" === m[s].dataSeries.type &&
                      ((v =
                ...
                ? ((z = Math.abs(
                  ...
                  z <= w && ((u = w = z), (y = s)))
                : ((z = Math.abs(
                    g - this.parent.convertValueToPixel(m[s].dataPoint.y)
                  )),
                  z <= w && ((w = z), (y = s)));
            p(u) || (w = Math.min(w, u));
          }
          ...
          if (
            ...
            for (m = 0; m < u.dataPoint.y.length; m++)
              (z = Math.abs(
                g - this.parent.convertValueToPixel(u.dataPoint.y[m])
              )),
                z < w && ((w = z), (s = m));
            v =
              1 === f.lineWidth % 2
            ...
            "stackedColumn" === u.dataSeries.type
              ...
              ? ((v = u.dataSeries.dataPointEOs[u.index].cumulativeY),
                (z = u.dataPoint.x.getTime
                  ? u.dataPoint.x.getTime()
                  : u.dataPoint.x),
                (b = 100 * (v / u.dataSeries.plotUnit.dataPointYSums[z])),
                (v =
                  1 === f.lineWidth % 2
                    ? (this.parent.convertValueToPixel(b) << 0) + 0.5
                    : this.parent.convertValueToPixel(b) << 0),
        ...
        if (
          ...
          "top" === this.parent._position &&
            ...
            this.value >=
              ...
              0 < n &&
              (f.moveTo(b, d), f.lineTo(e, l), f.stroke(), (this._hidden = !1));
        if (
          "left" === this.parent._position ||
          "right" === this.parent._position
        )
        ...
        if (
          ...
          (b = e = t = 1 === f.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (d = this.chart.plotArea.y1),
            (l = this.chart.plotArea.y2),
            (this.bounds = { x1: b - n / 2, y1: d, x2: e + n / 2, y2: l });
        else if (
          ...
          (d = l = v = 1 === f.lineWidth % 2 ? (g << 0) + 0.5 : g << 0),
            (b = this.chart.plotArea.x1),
            (e = this.chart.plotArea.x2),
            (this.bounds = { x1: b, y1: d - n / 2, x2: e, y2: l + n / 2 });
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                ...
                "dateTime" !== this.parent.valueType || this.parent.logarithmic
                  ? this.labelFormatter
                    ? this.labelFormatter({
                        ...
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: p(c) ? this.parent.convertPixelToValue(g) : c,
                      })
                    : p(this.options.label)
                    ? da(
                        p(c) ? this.parent.convertPixelToValue(g) : c,
                        this.valueFormatString,
                        this.chart._cultureInfo
                      )
                    : this.label
        ...
        if (
          ...
          if (this.chart.axisX)
            for (var A = 0; A < this.chart.axisX.length; A++) {
              for (
                var l =
                    "xySwapped" === this.chart.plotInfo.axisPlacement
                      ? this.chart.axisX[A].convertPixelToValue({ y: g })
          ...
          if (this.chart.axisX2)
            for (A = 0; A < this.chart.axisX2.length; A++) {
              l =
                "xySwapped" === this.chart.plotInfo.axisPlacement
                  ? this.chart.axisX2[A].convertPixelToValue({ y: g })
          ...
          for (b = 0; b < t.length; b++)
            t[b].dataPoint.x.valueOf() === c.dataPoint.x.valueOf() &&
              d.push(t[b]);
          t = null;
        } else {
        ...
        if (
          ...
          !1 === d.highlightEnabled ||
            ...
            "rangeSplineArea" === b.type
              ...
              ? sa(g, e.funnelSection, 0.3, "white")
              : "candlestick" === b.type
              ? ((g.globalAlpha = 1),
      ...
      if (
        ...
        for (var p = null, t = "", l = 0; l < a.length; l++) {
          ...
          if (0 === l && this.isToolTipDefinedInData && !this.content) {
            ...
            t = this.chart.replaceKeywordsWithValue(t, b, c, e);
          }
    ...
    V.prototype.show = function (a, d, c) {
      this._updateToolTip(a, d, "undefined" === typeof c ? !1 : c);
    };
    V.prototype.showAtIndex = function (a, d) {};
    V.prototype.showAtX = function (a, d) {
      if (!this.enabled) return !1;
      this.chart.clearedOverlayedCanvas = null;
      var c,
        b,
    ...
    W.prototype.getNewObjectTrackingId = function () {
      return ++this.lastObjectId;
    };
    W.prototype.mouseEventHandler = function (a) {
